...
vr_l087d6h:
        ld hl,l0a56ah          ;910a 21 76 3e  ! v >               (flow from: 87d4)  87d6 ld hl,b3b2 
...
vr_l08819h:
    ld hl,l0a56ch              ;914d 21 78 3e  ! x >               (flow from: 8818)  8819 ld hl,ac31 
...
l93a2h:
    ...
    ld hl,vr_l087d6h+1         ;93c1 21 17 2a  ! . *               (flow from: 8989)  8a8d ld hl,87d7
