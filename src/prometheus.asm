...
l5f06h:
    call 0028eh                ;5f06    cd 8e 02    . . .          (ghost flow from: 511d 5127)   511f call 028e 
...
l7fe4h:
    ...
    call 01e6ch                ;7fec    cd 6c 1e    . l .          (flow from: 76b6)   76b8 call 7c2c 
    ret nz                     ;7fef    c0      .                  (flow from: 7c34)   76bb ret nz 
    ld de,01915h               ;7ff0    11 15 19    . . .          (flow from: 76bb)   76bc ld de,76d5 
    ld b,00ah                  ;7ff3    06 0a   . .                (flow from: 76bc)   76bf ld b,0a 
l7ff5h:
    call 027eeh                ;7ff5    cd ee 27    . . '          (flow from: 76bf 76cb)   76c1 call 85ae 
...
l8013h:
    ...
    call 01df1h                ;803e    cd f1 1d    . . .          (flow from: 77fd)   770a call 7bb1 
l8041h:
...
l8044h:
    ...
    call 02c28h                ;804a    cd 28 2c    . ( ,          (flow from: 7e06)   7716 call 89e8 
    ld hl,019a0h               ;804d    21 a0 19    ! . .          (flow from: 8a1d)   7719 ld hl,7760 
...
l8053h:
    ...
    call 02488h                ;805a    cd 88 24    . . $          (flow from: 7724)   7726 call 8248 
    ...
    call 01a0ah                ;806e    cd 0a 1a    . . .          (flow from: 7737)   773a call 77ca 
    call 02375h                ;8071    cd 75 23    . u #          (flow from: 77d0)   773d call 8135 
    ...
    call 01a0ah                ;8079    cd 0a 1a    . . .          (flow from: 7742)   7745 call 77ca 
    ...
    ld hl,02ce5h               ;8083    21 e5 2c    ! . ,          (flow from: 774d)   774f ld hl,8aa5 
    ld de,02d3fh               ;8086    11 3f 2d    . ? -          (flow from: 774f)   7752 ld de,8aff 
    ld bc,00020h               ;8089    01 20 00    .   .          (flow from: 7752)   7755 ld bc,0020 
    ldir                       ;808c    ed b0   . .                (flow from: 7755 7758)   7758 ldir 
    call 0251bh                ;808e    cd 1b 25    . . %          (flow from: 7758)   775a call 82db 
    jp 0201dh                  ;8091    c3 1d 20    . .            (flow from: 82e5)   775d jp 7ddd 
    call 024a2h                ;8094    cd a2 24    . . $          (flow from: 7e38)   7760 call 8262 
...
l80a8h:
    ld hl,01f0fh               ;80a8    21 0f 1f    ! . .          (flow from: 7733)   7774 ld hl,7ccf 
...
l80dfh:
    ...
    ld (02356h),a              ;80fe    32 56 23    2 V #          (flow from: 773a 7745)   77ca ld (8116),a 
    ld (02357h),hl             ;8101    22 57 23    " W #          (flow from: 77ca)   77cd ld (8117),hl 
    ret                        ;8104    c9      .                  (flow from: 77cd)   77d0 ret 
l8105h:
    call 01e1ch                ;8105    cd 1c 1e    . . .          (flow from: 89ef)   77d1 call 7bdc 
    call 01e4dh                ;8108    cd 4d 1e    . M .          (flow from: 7c0c)   77d4 call 7c0d 
    ...
    call 022a8h                ;8112    cd a8 22    . . "          (flow from: 77dd)   77de call 8068 
    ...
    call 0194ah                ;8131    cd 4a 19    . J .          (flow from: 77fc)   77fd call 770a 
...
l84e1h:
    ...
    jp nc,022e2h               ;84f6    d2 e2 22    . . "          (flow from: 7bc1)   7bc2 jp nc,80a2 
...
l8510h:
    ...
    call 01df1h                ;8519    cd f1 1d    . . .          (flow from: 7be4)   7be5 call 7bb1 
    jr nc,l8510h               ;851c    30 f2   0 .                (flow from: 7bc6)   7be8 jr nc,7bdc 
    ld a,011h                  ;851e    3e 11   > .                (flow from: 7be8)   7bea ld a,11 
    call 022f4h                ;8520    cd f4 22    . . "          (flow from: 7bea)   7bec call 80b4 
...
l8533h:
    call 02984h                ;8533    cd 84 29    . . )          (flow from: 7bfb)   7bff call 8744 
    ...
    ld hl,01915h               ;8543    21 15 19    ! . .          (flow from: 7c0d)   7c0f ld hl,76d5 
l8546h:
...
l854eh:
    ...
    ld hl,01915h               ;8550    21 15 19    ! . .          (flow from: 7c1a)   7c1c ld hl,76d5 
...
l8556h:
    ...
    call 027eeh                ;8563    cd ee 27    . . '          (flow from: 7c2c)   7c2f call 85ae 
...
l8575h:
    ...
    ld sp,(05c3dh)             ;8581    ed 7b 3d 5c     . { = \    (flow from: 7c4c)   7c4d ld sp,(5c3d) 
    ...
    ret                        ;859f    c9      . 
    call 02472h                ;85a0    cd 72 24    . r $          (flow from: 7d77)   7c6c call 8232 
    call 02c64h                ;85a3    cd 64 2c    . d ,          (flow from: 8244)   7c6f call 8a24 
    ccf                        ;85a6    3f      ?                  (flow from: 8a2e)   7c72 ccf 
    jr l85afh                  ;85a7    18 06   . .                (flow from: 7c72)   7c73 jr 7c7b 
    call 02485h                ;85a9    cd 85 24    . . $          (flow from: 7d3e)   7c75 call 8245 
    call 02c6fh                ;85ac    cd 6f 2c    . o ,          (flow from: 825a)   7c78 call 8a2f 
l85afh:
    ...
    ld (024adh),hl             ;85b3    22 ad 24    " . $          (flow from: 7c7e)   7c7f ld (826d),hl 
...
l85dah:
    ...
    call 029a9h                ;85db    cd a9 29    . . )          (flow from: 7ca6)   7ca7 call 8769 
    ...
    call 01ee3h                ;8600    cd e3 1e    . . .          (flow from: 7cca)   7ccc call 7ca3 
l8603h:
    ...
    call 02521h                ;8609    cd 21 25    . ! %          (flow from: 7cd2)   7cd5 call 82e1 
    ld a,00fh                  ;860c    3e 0f   > .                (flow from: 82e5)   7cd8 ld a,0f 
    call 02c34h                ;860e    cd 34 2c    . 4 ,          (flow from: 7cd8)   7cda call 89f4 
    ld hl,02ce5h               ;8611    21 e5 2c    ! . ,          (flow from: 8a1d)   7cdd ld hl,8aa5 
    ld bc,l9e00h               ;8614    01 00 9e    . . .          (flow from: 7cdd)   7ce0 ld bc,9e00 
    call 02521h                ;8617    cd 21 25    . ! %          (flow from: 7ce0)   7ce3 call 82e1 
    ld hl,02d3fh               ;861a    21 3f 2d    ! ? -          (flow from: 82e5)   7ce6 ld hl,8aff 
...
l8622h:
    ld sp,02de1h               ;8622    31 e1 2d    1 . -          (flow from: 7c7c 7cec 7d36 7d43)   7cee ld sp,8ba1 
    call 024ach                ;8625    cd ac 24    . . $          (flow from: 7cee)   7cf1 call 826c 
l8628h:
    call 027feh                ;8628    cd fe 27    . . '          (flow from: 7d71 828e)   7cf4 call 85be 
    call 01a40h                ;862b    cd 40 1a    . @ .          (flow from: 85db)   7cf7 call 7800 
    call 02879h                ;862e    cd 79 28    . y (          (flow from: 7804)   7cfa call 8639 
    push af                    ;8631    f5      .                  (flow from: 86a0 86ad)   7cfd push af 
    ld a,00fh                  ;8632    3e 0f   > .                (flow from: 7cfd)   7cfe ld a,0f 
    call 02c34h                ;8634    cd 34 2c    . 4 ,          (flow from: 7cfe)   7d00 call 89f4 
    ...
    ld ix,(024adh)             ;8645    dd 2a ad 24     . * . $    (flow from: 7d0f)   7d11 ld ix,(826d) 
    ld hl,02d3fh               ;8649    21 3f 2d    ! ? -          (flow from: 7d11)   7d15 ld hl,8aff 
    push hl                    ;864c    e5      .                  (flow from: 7d15)   7d18 push hl 
    ld bc,02000h               ;864d    01 00 20    . .            (flow from: 7d18)   7d19 ld bc,2000 
    call 02521h                ;8650    cd 21 25    . ! %          (flow from: 7d19)   7d1c call 82e1 
    pop hl                     ;8653    e1      .                  (flow from: 82e5)   7d1f pop hl 
    call 02378h                ;8654    cd 78 23    . x #          (flow from: 7d1f)   7d20 call 8138 
...
l8665h:
    ...
    call 02c34h                ;8667    cd 34 2c    . 4 ,          (flow from: 7d31)   7d33 call 89f4 
...
l8672h:
    call 01eb5h                ;8672    cd b5 1e    . . .          (flow from: 7d3c)   7d3e call 7c75 
...
l86abh:
    call 01each                ;86ab    cd ac 1e    . . .          (flow from: 7d75 7d7a)   7d77 call 7c6c 
...
l870ch:
    call 0207bh                ;870c    cd 7b 20    . {            (flow from: 7dc8)   7dd8 call 7e3b 
    ...
    call 02521h                ;8717    cd 21 25    . ! %          (flow from: 7de0)   7de3 call 82e1 
    ld hl,02d3fh               ;871a    21 3f 2d    ! ? -          (flow from: 82e5)   7de6 ld hl,8aff 
    call 027eeh                ;871d    cd ee 27    . . '          (flow from: 7de6)   7de9 call 85ae 
    ...
    ld hl,01f0fh               ;8728    21 0f 1f    ! . .          (flow from: 7df2)   7df4 ld hl,7ccf 
    ...
    ld de,01209h               ;8731    11 09 12    . . .          (flow from: 7dfc)   7dfd ld de,6fc9 
...
l873bh:
    call 02127h                ;873b    cd 27 21    . ' !          (flow from: 7df2)   7e07 call 7ee7 
    call 02485h                ;873e    cd 85 24    . . $          (flow from: 8000)   7e0a call 8245 
    push hl                    ;8741    e5      .                  (flow from: 8255 825a)   7e0d push hl 
    ld (02bafh),hl             ;8742    22 af 2b    " . +          (flow from: 7e0d)   7e0e ld (896f),hl 
    ld de,02d61h               ;8745    11 61 2d    . a -          (flow from: 7e0e)   7e11 ld de,8b21 
    ...
    call 02cach                ;874b    cd ac 2c    . . ,          (flow from: 7e16)   7e17 call 8a6c 
    pop hl                     ;874e    e1      .                  (flow from: 8aa3)   7e1a pop hl 
    ld (024adh),hl             ;874f    22 ad 24    " . $          (flow from: 7e1a)   7e1b ld (826d),hl 
    ...
    call 02472h                ;8757    cd 72 24    . r $          (flow from: 7e21)   7e23 call 8232 
    ld (024adh),hl             ;875a    22 ad 24    " . $          (flow from: 8244)   7e26 ld (826d),hl 
    ld bc,00001h               ;875d    01 01 00    . . .          (flow from: 7e26)   7e29 ld bc,0001 
    call 02bcah                ;8760    cd ca 2b    . . +          (flow from: 7e29)   7e2c call 898a 
l8763h:
    ...
    jp 01f0fh                  ;876c    c3 0f 1f    . . .          (flow from: 7e35)   7e38 jp 7ccf 
...
l8810h:
    ...
    call nz,027afh             ;8821    c4 af 27    . . '          (flow from: 7eeb)   7eed call nz,856f 
    call 027f5h                ;8824    cd f5 27    . . '          (flow from: 7eed 8585)   7ef0 call 85b5 
    ld de,02d39h               ;8827    11 39 2d    . 9 -          (flow from: 85ba)   7ef3 ld de,8af9 
    ld c,005h                  ;882a    0e 05   . .                (flow from: 7ef3)   7ef6 ld c,05 
    call 027afh                ;882c    cd af 27    . . '          (flow from: 7ef6)   7ef8 call 856f 
    call 027f5h                ;882f    cd f5 27    . . '          (flow from: 8585 8590)   7efb call 85b5 
    ld de,02d25h               ;8832    11 25 2d    . % -          (flow from: 85ba)   7efe ld de,8ae5 
    ld c,012h                  ;8835    0e 12   . .                (flow from: 7efe)   7f01 ld c,12 
    call 027b3h                ;8837    cd b3 27    . . '          (flow from: 7f01)   7f03 call 8573 
    jr nz,l8840h               ;883a    20 04     .                (flow from: 8585 8590)   7f06 jr nz,7f0c 
    inc hl                     ;883c    23      #                  (flow from: 7f06)   7f08 inc hl 
    ld (02d38h),a              ;883d    32 38 2d    2 8 -          (flow from: 7f08)   7f09 ld (8af8),a 
l8840h:
    ld de,02d11h               ;8840    11 11 2d    . . -          (flow from: 7f06 7f09)   7f0c ld de,8ad1 
    ld c,012h                  ;8843    0e 12   . .                (flow from: 7f0c)   7f0f ld c,12 
    call 027b7h                ;8845    cd b7 27    . . '          (flow from: 7f0f)   7f11 call 8577 
    call 025cbh                ;8848    cd cb 25    . . %          (flow from: 8585)   7f14 call 838b 
    ld hl,02d39h               ;884b    21 39 2d    ! 9 -          (flow from: 839f)   7f17 ld hl,8af9 
    ...
    call 0275fh                ;8853    cd 5f 27    . _ '          (flow from: 7f1e)   7f1f call 851f 
    ld hl,02785h               ;8856    21 85 27    ! . '          (flow from: 8522)   7f22 ld hl,8545 
    call 02799h                ;8859    cd 99 27    . . '          (flow from: 7f22)   7f25 call 8559 
    pop hl                     ;885c    e1      .                  (flow from: 856e)   7f28 pop hl 
    call 02767h                ;885d    cd 67 27    . g '          (flow from: 7f28)   7f29 call 8527 
    jp c,022bdh                ;8860    da bd 22    . . "          (flow from: 8538)   7f2c jp c,807d 
l8863h:
    ...
    jp c,02241h                ;886c    da 41 22    . A "          (flow from: 7f36)   7f38 jp c,8001 
l886fh:
    ld hl,02d25h               ;886f    21 25 2d    ! % -          (flow from: 7f34 7f38)   7f3b ld hl,8ae5 
    push hl                    ;8872    e5      .                  (flow from: 7f3b)   7f3e push hl 
    call 0275fh                ;8873    cd 5f 27    . _ '          (flow from: 7f3e)   7f3f call 851f 
...
l8887h:
    jp nc,022c1h               ;8887    d2 c1 22    . . "          (flow from: 7f51)   7f53 jp nc,8081 
    or a                       ;888a    b7      .                  (flow from: 7f53)   7f56 or a 
    jp z,022c1h                ;888b    ca c1 22    . . "          (flow from: 7f56)   7f57 jp z,8081 
...
l88a3h:
    call 02720h                ;88a3    cd 20 27    .   '          (flow from: 7f45 7f66)   7f6f call 84e0 
l88a6h:
    ld (021cbh),a              ;88a6    32 cb 21    2 . !          (flow from: 7f5a 84e7 84f7 84fd 851c)   7f72 ld (7f8b),a 
    ld hl,02d11h               ;88a9    21 11 2d    ! . -          (flow from: 7f72)   7f75 ld hl,8ad1 
    call 02720h                ;88ac    cd 20 27    .   '          (flow from: 7f75)   7f78 call 84e0 
    ...
    call 02703h                ;88b8    cd 03 27    . . '          (flow from: 7f82)   7f84 call 84c3 
    ...
    call 02703h                ;88c0    cd 03 27    . . '          (flow from: 7f8a)   7f8c call 84c3 
...
l88d7h:
    ...
    jp po,022d8h               ;88dd    e2 d8 22    . . "          (flow from: 7fa7)   7fa9 jp po,8098 
...
l88fdh:
    call 02526h                ;88fd    cd 26 25    . & %          (flow from: 7fc3 7fc7)   7fc9 call 82e6 
    ld a,(021cbh)              ;8900    3a cb 21    : . !          (flow from: 8309 831b)   7fcc ld a,(7f8b) 
    cp 02ch                    ;8903    fe 2c   . ,                (flow from: 7fcc)   7fcf cp 2c 
    ld de,02d25h               ;8905    11 25 2d    . % -          (flow from: 7fcf)   7fd1 ld de,8ae5 
    call nc,025e0h             ;8908    d4 e0 25    . . %          (flow from: 7fd1)   7fd4 call nc,83a0 
    ...
    inc b                      ;891a    04      . 
l891bh:
    ld de,02d11h               ;891b    11 11 2d    . . -          (flow from: 7fda)   7fe7 ld de,8ad1 
    cp 02ch                    ;891e    fe 2c   . ,                (flow from: 7fe7)   7fea cp 2c 
    call nc,025e0h             ;8920    d4 e0 25    . . %          (flow from: 7fea)   7fec call nc,83a0 
l8923h:
...
l892fh:
    ...
    ld (02d61h),a              ;8931    32 61 2d    2 a -          (flow from: 7ffb)   7ffd ld (8b21),a 
    ...
    call 02526h                ;893b    cd 26 25    . & %          (flow from: 8005)   8007 call 82e6 
    push bc                    ;893e    c5      .                  (flow from: 8309 831b)   800a push bc 
    ld hl,02d24h               ;893f    21 24 2d    ! $ -          (flow from: 800a)   800b ld hl,8ae4 
...
l8944h:
    ...
    ld de,02d11h               ;8949    11 11 2d    . . -          (flow from: 8013)   8015 ld de,8ad1 
...
l895eh:
    ...
    ld de,02d25h               ;8969    11 25 2d    . % -          (flow from: 8033)   8035 ld de,8ae5 
l896ch:
    ld a,02ch                  ;896c    3e 2c   > ,                (flow from: 8035 8048)   8038 ld a,2c 
    call 025e0h                ;896e    cd e0 25    . . %          (flow from: 8038 8394)   803a call 83a0 
...
l89ceh:
    ...
    call 02835h                ;89eb    cd 35 28    . 5 (          (flow from: 80b4)   80b7 call 85f5 
    ...
    pop af                     ;89ff    f1      . 
l8a00h:
    ld hl,02de1h               ;8a00    21 e1 2d    ! . -          (flow from: 80bc)   80cc ld hl,8ba1 
l8a03h:
...
l8a0bh:
    ...
    call 029a7h                ;8a0c    cd a7 29    . . )          (flow from: 80d7)   80d8 call 8767 
...
l8a3ch:
    ...
    call 0234ch                ;8a47    cd 4c 23    . L #          (flow from: 8167)   8113 call 810c 
    ...
    ld hl,02ce5h               ;8a69    21 e5 2c    ! . ,          (flow from: 773d 8291)   8135 ld hl,8aa5 
    push hl                    ;8a6c    e5      .                  (flow from: 7d20 8135)   8138 push hl 
    ld bc,02000h               ;8a6d    01 00 20    . .            (flow from: 8138)   8139 ld bc,2000 
    call 02521h                ;8a70    cd 21 25    . ! %          (flow from: 8139)   813c call 82e1 
...
l8aa4h:
    ...
    call 0255ch                ;8aae    cd 5c 25    . \ %          (flow from: 8179)   817a call 831c 
...
l8ac8h:
    ...
    ld de,02eb6h               ;8ac9    11 b6 2e    . . .          (flow from: 8194)   8195 ld de,8c76 
    call 02509h                ;8acc    cd 09 25    . . %          (flow from: 8195)   8198 call 82c9 
    ld b,005h                  ;8acf    06 05   . .                (flow from: 82d3)   819b ld b,05 
    call 02514h                ;8ad1    cd 14 25    . . %          (flow from: 819b)   819d call 82d4 
...
l8ae2h:
    ...
    call 023fah                ;8ae4    cd fa 23    . . #          (flow from: 81af)   81b0 call 81ba 
    ...
    ld de,02ff4h               ;8af4    11 f4 2f    . . /          (flow from: 81be)   81c0 ld de,8db4 
    call 02509h                ;8af7    cd 09 25    . . %          (flow from: 81c0)   81c3 call 82c9 
...
l8b4ah:
    ...
    call 02356h                ;8b53    cd 56 23    . V #          (flow from: 821e)   821f call 8116 
    pop hl                     ;8b56    e1      .                  (flow from: 8134)   8222 pop hl 
    call 02406h                ;8b57    cd 06 24    . . $          (flow from: 8222)   8223 call 81c6 
...
l8b5ch:
    ...
    ld hl,(024adh)             ;8b66    2a ad 24    * . $          (flow from: 7c6c 7e23)   8232 ld hl,(826d) 
...
l8b77h:
    ...
    ld hl,(024adh)             ;8b79    2a ad 24    * . $          (flow from: 7c75 7e0a)   8245 ld hl,(826d) 
...
l8ba5h:
    call 02475h                ;8ba5    cd 75 24    . u $          (flow from: 826f 8274)   8271 call 8235 
...
l8bach:
    ...
    call 02830h                ;8baf    cd 30 28    . 0 (          (flow from: 827a)   827b call 85f0 
    pop ix                     ;8bb2    dd e1   . .                (flow from: 8607)   827e pop ix 
    call 024cfh                ;8bb4    cd cf 24    . . $          (flow from: 827e)   8280 call 828f 
    pop hl                     ;8bb7    e1      .                  (flow from: 82b1)   8283 pop hl 
    call 02488h                ;8bb8    cd 88 24    . . $          (flow from: 8283)   8284 call 8248 
    ...
    call 02375h                ;8bc5    cd 75 23    . u #          (flow from: 828f)   8291 call 8135 
    pop ix                     ;8bc8    dd e1   . .                (flow from: 8189 81b6)   8294 pop ix 
    call 02335h                ;8bca    cd 35 23    . 5 #          (flow from: 8294)   8296 call 80f5 
    jr c,l8bd4h                ;8bcd    38 05   8 .                (flow from: 8109)   8299 jr c,82a0 
    ld hl,02cedh               ;8bcf    21 ed 2c    ! . ,          (flow from: 8299)   829b ld hl,8aad 
    ld (hl),003h               ;8bd2    36 03   6 .                (flow from: 829b)   829e ld (hl),03 
l8bd4h:
    ld hl,02984h               ;8bd4    21 84 29    ! . )          (flow from: 8299 829e)   82a0 ld hl,8744 
    ld (02505h),hl             ;8bd7    22 05 25    " . %          (flow from: 82a0)   82a3 ld (82c5),hl 
    ld hl,02ce5h               ;8bda    21 e5 2c    ! . ,          (flow from: 82a3)   82a6 ld hl,8aa5 
...
l8bedh:
    ...
    call 0296eh                ;8bf1    cd 6e 29    . n )          (flow from: 82bb)   82bd call 872e 
    jr nz,l8bf8h               ;8bf4    20 02     .                (flow from: 8730 873c)   82c0 jr nz,82c4 
    and 0ffh                   ;8bf6    e6 ff   . .                (flow from: 82c0)   82c2 and ff 
l8bf8h:
    call 02984h                ;8bf8    cd 84 29    . . )          (flow from: 82c0 82c2)   82c4 call 8744 
    ...
    call 02408h                ;8c08    cd 08 24    . . $          (flow from: 816d 819d)   82d4 call 81c8 
    ...
    ld hl,02d07h               ;8c12    21 07 2d    ! . -          (flow from: 82db)   82de ld hl,8ac7 
l8c15h:
    ...
    ld hl,02d3fh               ;8c1c    21 3f 2d    ! ? -          (flow from: 82e6)   82e8 ld hl,8aff 
    call 027eeh                ;8c1f    cd ee 27    . . '          (flow from: 82e8)   82eb call 85ae 
...
l8c28h:
    ld (02d62h),de             ;8c28    ed 53 62 2d     . S b -    (flow from: 82f0 82f2)   82f4 ld (8b22),de 
...
l8c38h:
    ...
    ld ix,02d64h               ;8c39    dd 21 64 2d     . ! d -    (flow from: 8304)   8305 ld ix,8b24 
    ret c                      ;8c3d    d8      .                  (flow from: 8305)   8309 ret c 
    call 02a55h                ;8c3e    cd 55 2a    . U *          (flow from: 8309)   830a call 8815 
    ld ix,02d66h               ;8c41    dd 21 66 2d     . ! f -    (flow from: 8818 88e0)   830d ld ix,8b26 
...
l8c9fh:
    ...
    call 02703h                ;8cae    cd 03 27    . . '          (flow from: 8379)   837a call 84c3 
...
l8cb4h:
    ...
    call 02703h                ;8cb6    cd 03 27    . . '          (flow from: 8381)   8382 call 84c3 
...
l8cbch:
    ...
    ld hl,02d11h               ;8cbf    21 11 2d    ! . -          (flow from: 7f14)   838b ld hl,8ad1 
...
l8ccch:
    ...
    inc de                     ;8cde    13      . 
l8cdfh:
    call 026d2h                ;8cdf    cd d2 26    . . &          (flow from: 83a2 83a7)   83ab call 8492 
l8ce2h:
    jp c,022c9h                ;8ce2    da c9 22    . . "          (flow from: 8417 849d)   83ae jp c,8089 
...
l8cf5h:
    ...
    call 026cfh                ;8cf9    cd cf 26    . . &          (flow from: 83c3)   83c5 call 848f 
...
l8cfeh:
    ...
    call 0296eh                ;8d01    cd 6e 29    . n )          (flow from: 83cb)   83cd call 872e 
    ...
    call 02a55h                ;8d0c    cd 55 2a    . U *          (flow from: 83d7)   83d8 call 8815 
    ...
    ld hl,(02d07h)             ;8d1e    2a 07 2d    * . -          (flow from: 83e9)   83ea ld hl,(8ac7) 
    ...
    call 026d2h                ;8d28    cd d2 26    . . &          (flow from: 83f3)   83f4 call 8492 
    jr l8d31h                  ;8d2b    18 04   . .                (flow from: 849d 849f)   83f7 jr 83fd 
l8d2dh:
    ld a,c                     ;8d2d    79      y                  (flow from: 83d0)   83f9 ld a,c 
    call 02659h                ;8d2e    cd 59 26    . Y &          (flow from: 83f9)   83fa call 8419 
l8d31h:
...
l8d48h:
    call 026cfh                ;8d48    cd cf 26    . . &          (flow from: 8401)   8414 call 848f 
    ...
    call 02966h                ;8d53    cd 66 29    . f )          (flow from: 841d)   841f call 8726 
...
l8d6fh:
    call 026e0h                ;8d6f    cd e0 26    . . &          (flow from: 8438 845d)   843b call 84a0 
...
l8d7ah:
    jp c,022c5h                ;8d7a    da c5 22    . . "          (flow from: 8445)   8446 jp c,8085 
    ...
    jp nc,022c5h               ;8d82    d2 c5 22    . . "          (flow from: 844d)   844e jp nc,8085 
    ...
    call 026cfh                ;8d8d    cd cf 26    . . &          (flow from: 8458)   8459 call 848f 
...
l8dc1h:
    ...
    call 02ba2h                ;8dc3    cd a2 2b    . . +          (flow from: 83c5 8414 8459)   848f call 8962 
...
l8e0ah:
    ...
    call 0275fh                ;8e15    cd 5f 27    . _ '          (flow from: 84e0)   84e1 call 851f 
    ...
    ld hl,0278fh               ;8e21    21 8f 27    ! . '          (flow from: 84ec)   84ed ld hl,854f 
    call 02799h                ;8e24    cd 99 27    . . '          (flow from: 84ed)   84f0 call 8559 
    pop hl                     ;8e27    e1      .                  (flow from: 856e)   84f3 pop hl 
    call 02767h                ;8e28    cd 67 27    . g '          (flow from: 84f3)   84f4 call 8527 
...
l8eadh:
    call 027eeh                ;8ead    cd ee 27    . . '          (flow from: 8571 8575 8577 8597)   8579 call 85ae 
...
l8ecfh:
    call 027edh                ;8ecf    cd ed 27    . . '          (flow from: 85a8)   859b call 85ad 
...
l8ee9h:
    call 027eeh                ;8ee9    cd ee 27    . . '          (flow from: 7ef0 7efb 85bc)   85b5 call 85ae 
    ...
    call 02835h                ;8efb    cd 35 28    . 5 (          (flow from: 85c4)   85c7 call 85f5 
    ld hl,02d3eh               ;8efe    21 3e 2d    ! > -          (flow from: 8607)   85ca ld hl,8afe 
l8f01h:
    ...
    call 0298ah                ;8f10    cd 8a 29    . . )          (flow from: 85db)   85dc call 874a 
...
l8f15h:
    ...
    call 029a9h                ;8f1e    cd a9 29    . . )          (flow from: 85e8)   85ea call 8769 
...
l8f5ah:
    call 028eeh                ;8f5a    cd ee 28    . . (          (flow from: 8624 862e)   8626 call 86ae 
    ...
    call 028e8h                ;8f64    cd e8 28    . . (          (flow from: 862e)   8630 call 86a8 
l8f67h:
...
l8f6dh:
    call 028eeh                ;8f6d    cd ee 28    . . (          (flow from: 7cfa 861e 8636)   8639 call 86ae 
    ...
    call 02966h                ;8f90    cd 66 29    . f )          (flow from: 865a)   865c call 8726 
...
l8fa0h:
    ...
    call 0296eh                ;8fa7    cd 6e 29    . n )          (flow from: 8671)   8673 call 872e 
...
l8fafh:
    ...
    jp z,02854h                ;8fc0    ca 54 28    . T (          (flow from: 868b)   868c jp z,8614 
l8fc3h:
    push af                    ;8fc3    f5      .                  (flow from: 868c)   868f push af 
    call 0294fh                ;8fc4    cd 4f 29    . O )          (flow from: 868f)   8690 call 870f 
...
l8fd7h:
    ...
    call 0028eh                ;8fe3    cd 8e 02    . . .          (flow from: 8626 86ae)   86af call 028e 
...
l8ff7h:
    ...
    ld hl,02d3fh               ;8ffd    21 3f 2d    ! ? -          (flow from: 86c7)   86c9 ld hl,8aff 
    ...
    call 0296eh                ;900b    cd 6e 29    . n )          (flow from: 86d6)   86d7 call 872e 
...
l9078h:
    ...
    call 029bfh                ;9079    cd bf 29    . . )          (flow from: 8744)   8745 call 877f 
...
l908dh:
    ...
    call 029a7h                ;9090    cd a7 29    . . )          (flow from: 875b)   875c call 8767 
...
l909bh:
    ...
    call 029bfh                ;909e    cd bf 29    . . )          (flow from: 8769)   876a call 877f 
...
l90d9h:
    ...
    ld de,02d08h               ;90de    11 08 2d    . . -          (flow from: 8815)   87aa ld de,8ac8 
    ld b,000h                  ;90e1    06 00   . .                (flow from: 87aa)   87ad ld b,00 
l90e3h:
    call 027eeh                ;90e3    cd ee 27    . . '          (flow from: 87ad 87c9)   87af call 85ae 
    call 02966h                ;90e6    cd 66 29    . f )          (flow from: 85b1)   87b2 call 8726 
    ...
    call 0296eh                ;90f1    cd 6e 29    . n )          (flow from: 87bb)   87bd call 872e 
...
l9102h:
    ...
    ld (02d07h),a              ;9103    32 07 2d    2 . -          (flow from: 87ce)   87cf ld (8ac7),a 
...
l9121h:
    ...
    ld de,02d07h               ;912e    11 07 2d    . . -          (flow from: 87f9)   87fa ld de,8ac7 
...
l9143h:
    ...
    call 029eah                ;9149    cd ea 29    . . )          (flow from: 830a 83d8)   8815 call 87aa 
    ...
    call 022a8h                ;9153    cd a8 22    . . "          (flow from: 881c)   881f call 8068 
    ...
    call 02b2ch                ;9162    cd 2c 2b    . , +          (flow from: 882d)   882e call 88ec 
    ld hl,02a5ah               ;9165    21 5a 2a    ! Z *          (flow from: 88ee 8901)   8831 ld hl,881a 
    call 02bb8h                ;9168    cd b8 2b    . . +          (flow from: 8831)   8834 call 8978 
...
l917ah:
    ...
    ld de,02d08h               ;917d    11 08 2d    . . -          (flow from: 8848)   8849 ld de,8ac8 
l9180h:
...
l91a4h:
    ...
    ld a,(02d07h)              ;91af    3a 07 2d    : . -          (flow from: 887a)   887b ld a,(8ac7) 
...
l91f0h:
    call 0181bh                ;91f0    cd 1b 18    . . .          (flow from: 88d0)   88bc call 75db 
    ...
    call 02bc0h                ;91fb    cd c0 2b    . . +          (flow from: 88c6)   88c7 call 8980 
...
l922dh:
    ...
    ld ix,02d07h               ;9238    dd 21 07 2d     . ! . -    (flow from: 8902)   8904 ld ix,8ac7 
...
l925ah:
    ...
    call 02b81h                ;925d    cd 81 2b    . . +          (flow from: 8926)   8929 call 8941 
    ld de,003e8h               ;9260    11 e8 03    . . .          (flow from: 8961)   892c ld de,03e8 
    call 02b81h                ;9263    cd 81 2b    . . +          (flow from: 892c)   892f call 8941 
    ld de,00064h               ;9266    11 64 00    . d .          (flow from: 8961)   8932 ld de,0064 
    call 02b81h                ;9269    cd 81 2b    . . +          (flow from: 8932)   8935 call 8941 
    ld e,00ah                  ;926c    1e 0a   . .                (flow from: 8961)   8938 ld e,0a 
    call 02b81h                ;926e    cd 81 2b    . . +          (flow from: 8938)   893a call 8941 
l9271h:
...
l928eh:
    call 02ba3h                ;928e    cd a3 2b    . . +          (flow from: 8956)   895a call 8963 
    ...
    ld de,03e7eh               ;92a2    11 7e 3e    . ~ >          (flow from: 896d)   896e ld de,b252 
...
l92c3h:
    call 02488h                ;92c3    cd 88 24    . . $          (flow from: 898e)   898f call 8248 
    ...
    call 02b2ch                ;92e2    cd 2c 2b    . , +          (flow from: 89ad)   89ae call 88ec 
...
l92e7h:
    ...
    call 02c1ah                ;92f3    cd 1a 2c    . . ,          (flow from: 89bc)   89bf call 89da 
    ld hl,0232bh               ;92f6    21 2b 23    ! + #          (flow from: 89e5)   89c2 ld hl,80eb 
    call 02c1ah                ;92f9    cd 1a 2c    . . ,          (flow from: 89c2)   89c5 call 89da 
    ld hl,02a5ah               ;92fc    21 5a 2a    ! Z *          (flow from: 89e5)   89c8 ld hl,881a 
    call 02c11h                ;92ff    cd 11 2c    . . ,          (flow from: 89c8)   89cb call 89d1 
...
l9305h:
    ...
    call 018f6h                ;9320    cd f6 18    . . .          (flow from: 89e9)   89ec call 76b6 
    call 01a11h                ;9323    cd 11 1a    . . .          (flow from: 76cd)   89ef call 77d1 
    ld a,00ah                  ;9326    3e 0a   > .                (flow from: 7804)   89f2 ld a,0a 
    call 022f4h                ;9328    cd f4 22    . . "          (flow from: 7cda 7d00 7d33 89f2)   89f4 call 80b4 
...
l933ah:
    call 02984h                ;933a    cd 84 29    . . )          (flow from: 8a02 8a04)   8a06 call 8744 
    ld hl,(02a5ah)             ;933d    2a 5a 2a    * Z *          (flow from: 8749)   8a09 ld hl,(881a) 
    call 02c52h                ;9340    cd 52 2c    . R ,          (flow from: 8a09)   8a0c call 8a12 
    ld hl,(01b86h)             ;9343    2a 86 1b    * . .          (flow from: 8a1d)   8a0f ld hl,(7946) 
    call 0297dh                ;9346    cd 7d 29    . } )          (flow from: 8a0c 8a0f)   8a12 call 873d 
    call 02b42h                ;9349    cd 42 2b    . B +          (flow from: 8749)   8a15 call 8902 
    ld hl,02d07h               ;934c    21 07 2d    ! . -          (flow from: 8961)   8a18 ld hl,8ac7 
l934fh:
    ...
    call 02981h                ;9352    cd 81 29    . . )          (flow from: 8a1d)   8a1e call 8741 
...
l93a2h:
    ...
    call 022a8h                ;93a4    cd a8 22    . . "          (flow from: 8a6f)   8a70 call 8068 
    ...
    call 02b2ch                ;93b7    cd 2c 2b    . , +          (flow from: 8a82)   8a83 call 88ec 
    pop bc                     ;93ba    c1      .                  (flow from: 8901)   8a86 pop bc 
    ld hl,02a5ah               ;93bb    21 5a 2a    ! Z *          (flow from: 8a86)   8a87 ld hl,881a 
    call 02bc0h                ;93be    cd c0 2b    . . +          (flow from: 8a87)   8a8a call 8980 
    ld hl,02a17h               ;93c1    21 17 2a    ! . *          (flow from: 8989)   8a8d ld hl,87d7 
    call 02bc0h                ;93c4    cd c0 2b    . . +          (flow from: 8a8d)   8a90 call 8980 
    ld hl,02328h               ;93c7    21 28 23    ! ( #          (flow from: 8989)   8a93 ld hl,80e8 
    call 02ba9h                ;93ca    cd a9 2b    . . +          (flow from: 8a93)   8a96 call 8969 
