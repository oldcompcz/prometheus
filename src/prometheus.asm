...
l68cah:
    ...
    ld (errorAction+1),hl      ;68de 22 e0 22  " . "               (flow (mon) from: 5fa7)  5faa ld (80a0),hl  
    ld hl,clearStringBuffers   ;68e1 21 1b 25  ! . %               (flow (mon) from: 5faa)  5fad ld hl,82db 
...
l69ffh:
    ...
    call monitorInputBuffersInitialization      ;6a02 cd 9a 08     (flow (mon) from: 60cb)  60ce call 665a 
    ld (inputBufferStart),de   ;6a05 ed 53 3f 2d  . S ? -          (flow (mon) from: 82e5)  60d1 ld (8aff),de 
    ld (l6a0dh+1),sp         ;6a09 ed 73 1a 03  . s . .            (flow (mon) from: 60d1)  60d5 ld (60da),sp 
l6a0dh:
    ld sp,00000h               ;6a0d 31 00 00  1 . .               (flow (mon) from: 60d5)  60d9 ld sp,8b9b 
    call clearStringBuffers    ;6a10 cd 1b 25  . . %               (flow (mon) from: 60d9)  60dc call 82db 
    ld hl,v_l612dh             ;6a13 21 6d 03  ! m .               (flow (mon) from: 82e5)  60df ld hl,612d 
    ld (errorAction+1),hl      ;6a16 22 e0 22  " . "               (flow (mon) from: 60df)  60e2 ld (80a0),hl 
    call l6fa9h                ;6a19 cd b5 08  . . .               (flow (mon) from: 60e2)  60e5 call 6675 
    ld hl,inputBufferStart+1   ;6a1c 21 40 2d  ! @ - 
    call atHLorNextIfOne       ;6a1f cd ee 27  . . ' 
    cp 03ah                    ;6a22 fe 3a  . : 
    ret z                      ;6a24 c8  . 
v_l60f1h:
    jp readNumberExpression    ;6a25 c3 dd 13  . . . 
...
l6a2bh:
    ...
    ld hl,(varcAddressCounter+1)  ;6a3f 2a 94 1b  * . . 
...
v_sub_6113h:
    ld hl,(frontPanelEditLineItem)  ;6a47 2a 03 00  * . .          (flow (mon) from: 5fc3 666f)  6113 ld hl,(5dc3) 
...
l6b2dh:
    ...
    scf                        ;6b30 37  7 
    call loadRoutine           ;6b31 cd f1 1d  . . . 
    ret c                      ;6b34 d8  . 
...
monLoadHeader:
    ...
    ld ix,lineBuffer+3         ;6b4c dd 21 e8 2c  . ! . , 
...
l6bb6h:
    ...
    push hl                    ;6bc2 e5  . 
    ld hl,l06bebh              ;6bc3 21 f7 04  ! . . 
    ld (errorAction+1),hl      ;6bc6 22 e0 22  " . " 
    pop hl                     ;6bc9 e1  . 
    ex de,hl                   ;6bca eb  . 
l6bcbh:
    push de                    ;6bcb d5  . 
    call l0733eh               ;6bcc cd 4a 0c  . J . 
...
v_l62d1h:
    ld hl,lineBuffer           ;6c05 21 e5 2c  ! . , 
    ld de,inputBufferStart     ;6c08 11 3f 2d  . ? - 
    ld bc,00020h               ;6c0b 01 20 00  .   . 
    ldir                       ;6c0e ed b0  . . 
v_sub_62dch:
    call clearStringBuffers    ;6c10 cd 1b 25  . . % 
...
monBreakpoint:
    ...
    ld (errorAction+1),hl      ;6c36 22 e0 22  " . " 
...
l6cd6h:
    ...
    ld a,(varcHexMode+1)       ;6cda 3a 49 2b  : I + 
    push bc                    ;6cdd c5  . 
    or a                       ;6cde b7  . 
...
setRegisterValue:
    call monitorInputBuffersInitialization   ;6e32 cd 9a 08  . . . 
    ld hl,001c5h               ;6e35 21 c5 01  ! . . 
    ld (inputBufferStart),hl   ;6e38 22 3f 2d  " ? - 
    ld hl,v_l64f9h             ;6e3b 21 39 07  ! 9 . 
    ld (errorAction+1),hl      ;6e3e 22 e0 22  " . " 
    ld (l6e45h+1),sp           ;6e41 ed 73 52 07  . s R . 
l6e45h:
    ld sp,00000h               ;6e45 31 00 00  1 . . 
    call clearStringBuffers    ;6e48 cd 1b 25  . . % 
    call l6fa9h                ;6e4b cd b5 08  . . . 
    ld b,018h                  ;6e4e 06 18  . . 
    ld ix,frontPanelRegistersItems  ;6e50 dd 21 1f 00  . ! . . 
l6e54h:
...
l6f29h:
    inc hl                     ;6f29 23  # 
l6f2ah:
    ld ix,lineBuffer+2         ;6f2a dd 21 e7 2c  . ! . , 
    dec a                      ;6f2e 3d  = 
...
v_sub_66b9h:
    ...
    ld (v_l80a2h+1),hl         ;6ff4 22 e3 22  " . " 
    ret nc                     ;6ff7 d0  . 
v_l66c4h:
    ld a,0cdh                  ;6ff8 3e cd  > . 
v_l66c6h:
    call monitorInputBuffersInitialization  ;6ffa cd 9a 08  . . . 
...
v_l66d8h:
    ...
    call beep                  ;700f cd 53 29  . S ) 
    call processKey            ;7012 cd 79 28  . y ( 
...
v_sub_6a19h:
    ...
    ld (l0733eh+1),a           ;734e 32 4b 0c  2 K .               (flow (mon) from: 6a19)  6a1a ld (6a0b),a
...
l73f6h:
    ...
    call writeCodeLineFromIXtoLineBuffer  ;73fe cd 75 23  . u #    (flow (mon) from: 6ac6)  6aca call 8135 
    ld ix,lineBuffer           ;7401 dd 21 e5 2c  . ! . ,          (flow (mon) from: 81b6 81dd 822d)  6acd ld ix,8aa5 
    ld de,(l073bdh+1)          ;7405 ed 5b ca 0c  . [ . .          (flow (mon) from: 6acd)  6ad1 ld de,(6a8a) 
    ld a,(l073c4h+1)           ;7409 3a d1 0c  : . .               (flow (mon) from: 6ad1)  6ad5 ld a,(6a91) 
    ...
    call writeLabel            ;7414 cd 56 23  . V # 
...
v_sub_6b14h:
    ...
    ld hl,(varcSymbolTablePt+1) ;744d 2a 17 2a  * . *              (flow (mon) from: 6b16)  6b19 ld hl,(87d7) 
    ...
    ld (l07474h+1),hl          ;7457 22 81 0d  " . .               (flow (mon) from: 6b22)  6b23 ld (6b41),hl 
...
l74e6h:
   ld (l0733eh+1),a            ;74e6 32 4b 0c  2 K .               (flow (mon) from: 6bae)  6bb2 ld (6a0b),a 
    ...
    ld (l070fbh+1),a           ;74f2 32 08 0a  2 . .               (flow (mon) from: 6bbc)  6bbe ld (67c8),a 
    xor a                      ;74f5 af  .                         (flow (mon) from: 6bbe)  6bc1 xor a 
    ld (l070fbh+2),a           ;74f6 32 09 0a  2 . .               (flow (mon) from: 6bc1)  6bc2 ld (67c9),a 
...
l7523h:
    pop hl                     ;7523 e1  . 
    pop hl                     ;7524 e1  . 
    ld hl,(varcCodeEndPt+1)    ;7525 2a 5a 2a  * Z * 
    push hl                    ;7528 e5  . 
    ld hl,(v_sub_7931h+1)      ;7529 2a 72 1b  * r . 
    push hl                    ;752c e5  . 
l752dh:
    and a                      ;752d a7  . 
    dec a                      ;752e 3d  = 
...
v_sub_6c20h:
    ...
    ld hl,(varcCodeEndPt+1)    ;755d 2a 5a 2a  * Z *               (flow (mon) from: 6c28)  6c29 ld hl,(881a) 
    push hl                    ;7560 e5  .                         (flow (mon) from: 6c29)  6c2c push hl 
    ld hl,(v_sub_7931h+1)      ;7561 2a 72 1b  * r .               (flow (mon) from: 6c2c)  6c2d ld hl,(7932) 
...
v_sub_6c4ah:
    push hl                    ;757e e5  . 
    ld hl,(frontPanelListWindowItem)   ;757f 2a 0a 00  * . . 
    ld a,l                     ;7582 7d  } 
    and 0e0h                   ;7583 e6 e0  . . 
    ld l,a                     ;7585 6f  o 
...
l759dh:
    ld (varcPrintingPosition+1),hl       ;759d 22 c8 29  " . ) 
    pop hl                     ;75a0 e1  . 
v_sub_6c6dh:
...
l75b0h:
    call displayNormalCharacter;75b0 cd a9 29  . . )               (flow (mon) from: 6c78 6c7a)  6c7c call 8769 
...
l7623h:
    ...
    xor a                      ;7627 af  . 
l7628h:
    ld (varcActiveMonitorEditorItem+1),a  ;7628 32 fa 0e  2 . . 
    ret                        ;762b c9  . 
l762ch:
...
v_l6d67h:
    ld e,h                     ;769b 5c  \ 
    rst ROM_MaskableInterrupt  ;769c ff  . 
    add a,b                    ;769d 80  . 
    ld e,(hl)                  ;769e 5e  ^ 
    rst ROM_MaskableInterrupt  ;769f ff  . 
    ld b,b                     ;76a0 40  @ 
    ld hl,(020ffh)             ;76a1 2a ff 20  * .   
    ccf                        ;76a4 3f  ? 
    rst ROM_MaskableInterrupt  ;76a5 ff  . 
...
v_sub_6d84h:
    ld ix,frontPanelItemsTable ;76b8 dd 21 03 00  . ! . . 
...
l76ceh:
    ...
    call displayNormalCharacter;76d0 cd a9 29  . . ) 
    pop hl                     ;76d3 e1  . 
    push hl                    ;76d4 e5  . 
    call v_sub_6f5dh           ;76d5 cd 9d 11  . . . 
    ld a,029h                  ;76d8 3e 29  > ) 
l76dah:
    call displayUninvertedCharacter  ;76da cd a7 29  . . )         (flow (mon) from: 6dd4)  6da6 call 8767 
...
l771bh:
    ld bc,l0781eh+2            ;771b 01 2c 11  . , .               (flow (mon) from: 6de4 6e41)  6de7 ld bc,6eec 
...
l7744h:
    ...
    ld (varcPrintingPosition+1),hl       ;776c 22 c8 29  " . )     (flow (mon) from: 6f98)  6e38 ld (8788),hl 
    xor a                      ;776f af  .                         (flow (mon) from: 6e38)  6e3b xor a 
    ld (v_sub_6ef4h+1),a       ;7770 32 35 11  2 5 .               (flow (mon) from: 6e3b)  6e3c ld (6ef5),a 
l7773h:
...
l77b1h:
    ...
    call l0733eh               ;77b2 cd 4a 0c  . J .               (flow (mon) from: 6e7d)  6e7e call 6a0a 
...
v_l6e9ch:
    ...
    ld (varcPrintingPosition+1),hl       ;77ec 22 c8 29  " . ) 
    ex af,af'                  ;77ef 08  . 
    call v_sub_6f36h           ;77f0 cd 76 11  . v . 
    pop hl                     ;77f3 e1  . 
    ret                        ;77f4 c9  . 
l77f5h:
    call displaySpace          ;77f5 cd a5 29  . . )               (flow (mon) from: 6edb)  6ec1 call 8765 
l77f8h:
...
l7803h:
    ...
    call c,displaySpace        ;7806 dc a5 29  . . )               (flow (mon) from: 6ed1)  6ed2 call c,8765 
...
v_sub_6ef4h:
    ...
    call nz,displaySpace       ;782b c4 a5 29  . . )               (flow (mon) from: 6ef6)  6ef7 call nz,8765 
    ld a,001h                  ;782e 3e 01  > .                    (flow (mon) from: 6ef7 877e)  6efa ld a,01 
    ld (v_sub_6ef4h+1),a       ;7830 32 35 11  2 5 .               (flow (mon) from: 6efa)  6efc ld (6ef5),a 
...
v_l6f01h:
    ...
    call printDecNumberToIX    ;7840 cd 66 2b  . f +               (flow (mon) from: 6f6e)  6f0c call 8926 
...
l785ch:
    ...
    call displayNormalCharacter;785f cd a9 29  . . )               (flow (mon) from: 6f2a)  6f2b call 8769 
...
l786eh:
    ...
    call displayNormalCharacter;7872 cd a9 29  . . )               (flow (mon) from: 6f3c)  6f3e call 8769 
    ...
    ld (v_sub_6ef4h+1),a       ;787e 32 35 11  2 5 .               (flow (mon) from: 6f49)  6f4a ld (6ef5),a 
...
v_sub_6f75h:
    ...
    call isLetter              ;78ac cd 6e 29  . n )               (flow (mon) from: 6f76)  6f78 call 872e 
    jr nz,l78b3h               ;78af 20 02    .                    (flow (mon) from: 8730 8733 873c)  6f7b jr nz,6f7f 
    sub 020h                   ;78b1 d6 20  .                      (flow (mon) from: 6f7b)  6f7d sub 20 
l78b3h:
    call displayUninvertedCharacter  ;78b3 cd a7 29  . . )         (flow (mon) from: 6f7b 6f7d)  6f7f call 8767 
...
invokeE:
    ...
    call getLastSourcePosition ;7aba cd ce 13  . . . 
    call getPreviousLine       ;7abd cd 75 24  . u $ 
    jr setActiveLine                  ;7ac0 18 f4  . . 
...
invokeUTop:
    ...
    call readNumberExpression  ;7aca cd dd 13  . . . 
    ld (varcUTop+1),hl         ;7acd 22 86 1b  " . . 
    ret                        ;7ad0 c9  . 


readNumberExpression:
    ld hl,inputBufferStart+1   ;7ad1 21 40 2d  ! @ - 
v_sub_71a0h:
    ld de,commandArgumentBuffer;7ad4 11 11 2d  . . - 
    push de                    ;7ad7 d5  . 
    ld c,01eh                  ;7ad8 0e 1e  . . 
    call readCommandArgument   ;7ada cd b7 27  . . ' 
    pop de                     ;7add d1  . 
    ld hl,00000h               ;7ade 21 00 00  ! . . 
    ld a,"+"                   ;7ae1 3e 2b  > + 
    ld ix,lineBuffer            ;7ae3 dd 21 e5 2c  . ! . , 
l7ae7h:
    push hl                    ;7ae7 e5  . 
    push af                    ;7ae8 f5  . 
    call testClosingBracketOrComma  ;7ae9 cd d2 26  . . & 
...
l7afah:
    call testClosingBracketOrComma  ;7afa cd d2 26  . . & 
l7afdh:
    cp "$"                     ;7afd fe 24  . $ 
    ld hl,(varcAddressCounter+1)  ;7aff 2a 94 1b  * . . 
    jr z,l7b31h                ;7b02 28 2d  ( - 
    call isLetter              ;7b04 cd 6e 29  . n ) 
    ...
    ld a,MESSAGE_UNKNOWN       ;7b11 3e 09  > . 
    jp c,signalError           ;7b13 da da 22  . . " 
    pop ix                     ;7b16 dd e1  . . 
    ex de,hl                   ;7b18 eb  . 
    call writeLabel            ;7b19 cd 56 23  . V # 
    ld a,(hl)                  ;7b1c 7e  ~ 
    and 0c0h                   ;7b1d e6 c0  . . 
    ld a,MESSAGE_UNKNOWN       ;7b1f 3e 09  > . 
    jp z,signalError           ;7b21 ca da 22  . . " 
    dec de                     ;7b24 1b  . 
    ex de,hl                   ;7b25 eb  . 
    ld d,(hl)                  ;7b26 56  V 
    dec hl                     ;7b27 2b  + 
    ...
    ex de,hl                   ;7b30 eb  . 
l7b31h:
    call testClosingBracketOrComma   ;7b31 cd d2 26  . . & 
...
l7b52h:
    ...
    call comparePositionWithCodeEnd  ;7b55 cd 6f 2c  . o , 
...
invokeReplace:
    ...
    call writeCodeLineFromIXtoLineBuffer  ;7b78 cd 75 23  . u # 
    ld hl,lineBuffer           ;7b7b 21 e5 2c  ! . , 
...
l7bb5h:
    inc a                      ;7bb5 3c  < 
    ld (de),a                  ;7bb6 12  . 
    ld (varcInsertMode+1),a    ;7bb7 32 5f 20  2 _   
    dec a                      ;7bba 3d  = 
    inc c                      ;7bbb 0c  . 
l7bbch:
    ld (de),a                  ;7bbc 12  . 
...
vr_l072ddh:
    ...
    call moveToNextLine        ;7c14 cd 88 24  . . $ 
    ld (vr_l072ddh+1),hl       ;7c17 22 1e 15  " . . 
    call comparePositionWithCodeEnd   ;7c1a cd 6f 2c  . o , 
    ret nc                     ;7c1d d0  . 
    push hl                    ;7c1e e5  . 
    pop ix                     ;7c1f dd e1  . . 
vr_l072edh:
...
v_l7332h:
    ...
    rst ROM_PrintACharacter    ;7c74 d7  . 
    xor a                      ;7c75 af  . 
    ret                        ;7c76 c9  . 


invokeDelete:
    call getSelectedBlock      ;7c77 cd 27 23  . ' # 
...
l7c7dh:
    ...
    inc bc                     ;7c84 03  . 
    call moveToNextLine        ;7c85 cd 88 24  . . $ 
    jr l7c7dh                  ;7c88 18 f3  . . 
l7c8ah:
    call getSelectedBlock      ;7c8a cd 27 23  . ' # 
    call v_sub_721ah           ;7c8d cd 5a 14  . Z . 
    call comparePositionWithCodeEnd  ;7c90 cd 6f 2c  . o , 
    call z,getPreviousLine     ;7c93 cc 75 24  . u $ 
    ld (varcSelectedBlockStart+1),hl     ;7c96 22 28 23  " ( # 
    ld (varcSelectedBlockEnd+1),hl       ;7c99 22 2b 23  " + # 
l7c9ch:
    ld (varcSourceBufferActiveLine+1),hl   ;7c9c 22 ad 24  " . $ 
    ret                        ;7c9f c9  . 
v_l736ch:
    ld de,lineBuffer           ;7ca0 11 e5 2c  . . , 
l7ca3h:
    push de                    ;7ca3 d5  . 
...
l7d1ch:
    ...
    ld a,MESSAGE_SOURCE_ERROR  ;7d30 3e 10  > . 
    jp signalError             ;7d32 c3 da 22  . . " 
l7d35h:
    ld c,(hl)                  ;7d35 4e  N 
    pop hl                     ;7d36 e1  . 
    ld e,(hl)                  ;7d37 5e  ^ 
...
l7dbbh:
    push af                    ;7dbb f5  . 
    call clearLine             ;7dbc cd 30 28  . 0 ( 
    pop af                     ;7dbf f1  . 
    ...
    exx                        ;7dc6 d9  . 
    xor a                      ;7dc7 af  . 
    call displaySymbolTableColumn           ;7dc8 cd 02 16  . . . 
    ld a,088h                  ;7dcb 3e 88  > . 
    call displaySymbolTableColumn           ;7dcd cd 02 16  . . . 
    exx                        ;7dd0 d9  . 
    call processKey            ;7dd1 cd 79 28  . y ( 
    ; BREAK
    cp " "                     ;7dd4 fe 20  .   
l7dd6h:
    jp z,startPrometheus       ;7dd6 ca 09 1f  . . . 
    exx                        ;7dd9 d9  . 
    jr displaySymbolTablePage  ;7dda 18 d8  . .
...
invokeTable:
    ...
    jr z,processSymbolTableItems  ;7dea 28 09  ( . 
...
processSymbolTableItems:
    ; modifies all symbol table records 
    ; in C expect symbol table modifier, see symbolTableModifier
    ld a,c                     ;7df5 79  y 
...
invokeClear: 
    ...
    ld (varcSelectedBlockStart+1),hl     ;7e13 22 28 23  " ( # 
    call getLastSourcePosition ;7e16 cd ce 13  . . . 
    ld (varcSelectedBlockEnd+1),hl       ;7e19 22 2b 23  " + # 
...
clearSymbolTable:
    ...
    call processSymbolTableItems   ;7e24 cd 01 17  . . . 
...
l7e2dh:
    ...
    ld h,a                     ;7e33 67  g 
    add hl,hl                  ;7e34 29  ) 
    ld de,(varcSymbolTablePt+1)       ;7e35 ed 5b 17 2a  . [ . * 
    add hl,de                  ;7e39 19  . 
    inc hl                     ;7e3a 23  # 
    set 6,(hl)                 ;7e3b cb f6  . . 
    pop hl                     ;7e3d e1  . 
...
l7e44h:
    ld hl,(varcSymbolTablePt+1)       ;7e44 2a 17 2a  * . * 
    ld c,(hl)                  ;7e47 4e  N 
    inc hl                     ;7e48 23  # 
    ld b,(hl)                  ;7e49 46  F 
    inc hl                     ;7e4a 23  # 
...
l7e52h:
    ...
    jp processSymbolTableItems ;7e58 c3 01 17  . . . 
l7e5bh:
    dec bc                     ;7e5b 0b  . 
...
l7e79h:
    ...
    ld b,h                     ;7e84 44  D 
    ld c,l                     ;7e85 4d  M 
    ld hl,varcCodeEndPt+1      ;7e86 21 5a 2a  ! Z * 
    ...
    ld hl,varcCodeEndPt+1      ;7e9e 21 5a 2a  ! Z * 
...
l7ea8h:
    ...
    ld hl,(varcSymbolTablePt+1)       ;7eb0 2a 17 2a  * . * 
    push hl                    ;7eb3 e5  . 
    inc bc                     ;7eb4 03  . 
...
l7ed5h:
    ...
    ld de,(varcSymbolTablePt+1)       ;7ed8 ed 5b 17 2a  . [ . * 
...
v_sub_75e9h:
l7f1dh:
    call comparePositionWithCodeEnd  ;7f1d cd 6f 2c  . o , 
    ret nc                     ;7f20 d0  . 
    inc hl                     ;7f21 23  # 
    ld a,(hl)                  ;7f22 7e  ~ 
    and 00fh                   ;7f23 e6 0f  . . 
...
l7f54h:
    ld hl,fileNameBuffer       ;7f54 21 15 19  ! . . 
    ld de,BOTTOM_LINE_VRAM_ADDRESS+1   ;7f57 11 e1 50  . . P 
...
l7f6eh:
    call getSelectedBlock      ;7f6e cd 27 23  . ' # 
    ex de,hl                   ;7f71 eb  . 
    call moveToNextLine        ;7f72 cd 88 24  . . $ 
l7f75h:
    push de                    ;7f75 d5  . 
    ...
    ld (BOTTOM_LINE_VRAM_ADDRESS+15),hl             ;7f81 22 ef 50  " . P 
    ld hl,(varcCodeEndPt+1)    ;7f84 2a 5a 2a  * Z * 
    ld de,(varcSymbolTablePt+1)  ;7f87 ed 5b 17 2a  . [ . * 
    and a                      ;7f8b a7  . 
    ...
    inc hl                     ;7f9a 23  # 
    inc hl                     ;7f9b 23  # 
    ld (BOTTOM_LINE_VRAM_ADDRESS + 11),hl             ;7f9c 22 eb 50  " . P 
    ld a,MESSAGE_START_TAPE    ;7f9f 3e 0c  > . 
    push ix                    ;7fa1 dd e5  . . 
...
v_sub_76bch:
    ld de,fileNameBuffer       ;7ff0 11 15 19  . . .               (flow from: 76bb)  76bc ld de,76d5 
v_sub_76bfh:
    ld b,MAX_FILE_NAME_LENGTH  ;7ff3 06 0a  . .                    (flow from: 76bc)  76bf ld b,0a 
l7ff5h:
...
v_sub_770ah:
    call loadRoutine           ;803e cd f1 1d  . . .               (flow from: 77fd)  770a call 7bb1 
l8041h:
    ret c                      ;8041 d8  .                         (flow from: 7bc6)  770d ret c 
    ld a,MESSAGE_TAPE_ERROR    ;8042 3e 0d  > . 
l8044h:
...
vr_l0771fh:
    ...
    call moveToNextLine        ;805a cd 88 24  . . $               (flow from: 7724)  7726 call 8248 
...
vr_l07737h:
    ...
    call setSymbolTableSizeAndPosition   ;806e cd 0a 1a  . . .     (flow from: 7737)  773a call 77ca 
    call writeCodeLineFromIXtoLineBuffer   ;8071 cd 75 23  . u #   (flow from: 77d0)  773d call 8135 
    ld a,02ah                  ;8074 3e 2a  > *                    (flow from: 8189 81b6 81dd 822d 8231)  7740 ld a,2a 
    ld hl,varcSymbolTablePt+1         ;8076 21 17 2a  ! . *        (flow from: 7740)  7742 ld hl,87d7 
    call setSymbolTableSizeAndPosition  ;8079 cd 0a 1a  . . .      (flow from: 7742)  7745 call 77ca 
    ld a,(varcLastStatusBarMessage+1)   ;807c 3a 3f 1f  : ? .      (flow from: 77d0)  7748 ld a,(7cff) 
    cp MESSAGE_SOURCE_ERROR    ;807f fe 10  . .                    (flow from: 7748)  774b cp 10 
    jr z,l8044h                ;8081 28 c1  ( .                    (flow from: 774b)  774d jr z,7710 
    ld hl,lineBuffer           ;8083 21 e5 2c  ! . ,               (flow from: 774d)  774f ld hl,8aa5 
    ...
    call clearStringBuffers    ;808e cd 1b 25  . . %               (flow from: 7758)  775a call 82db 
...
v_l7760h:
    ...
    ld hl,(varcCodeEndPt+1)    ;809b 2a 5a 2a  * Z *               (flow from: 7763)  7767 ld hl,(881a) 
    and a                      ;809e a7  .                         (flow from: 7767)  776a and a 
    sbc hl,de                  ;809f ed 52  . R                    (flow from: 776a)  776b sbc hl,de 
    jr c,vr_l0771fh            ;80a1 38 b0  8 .                    (flow from: 776b)  776d jr c,771f 
...
setSymbolTableSizeAndPosition:
    ld (varcSymbolTableInderectPt),a      80fe 32 56 23  2 V #     (flow from: 773a 7745)  77ca ld (8116),a 
    ld (varcSymbolTableInderectPt+1),hl   ;8101 22 57 23  " W #    (flow from: 77ca)  77cd ld (8117),hl 
...
l8105h:
    ...
    ld hl,(BOTTOM_LINE_VRAM_ADDRESS + 11)  ;810d 2a eb 50  * . P   (flow from: 77d7)  77d9 ld hl,(50eb) 
    ...
    ld hl,(varcUTop+1)         ;8116 2a 86 1b  * . .               (flow from: 77e1)  77e2 ld hl,(7946) 
    ...
    ld bc,(BOTTOM_LINE_VRAM_ADDRESS + 15)  ;8120 ed 4b ef 50  . K  (flow from: 77e9)  77ec ld bc,(50ef) 
...
l8184h:
    ...
    dec a                      ;8186 3d  = 
    ld (l8184h+1),a            ;8187 32 91 1a  2 . . 
    ld hl,v_sub_78dah          ;818a 21 1a 1b  ! . . 
    ld (l817ch+1),hl           ;818d 22 89 1a  " . . 
...
l81c3h:
    ...
    jp c,l825eh                ;81c6 da 6a 1b  . j . 
    call l825eh                ;81c9 cd 6a 1b  . j . 
    inc ix                     ;81cc dd 23  . # 
...
l81e4h:
    ld a,d                     ;81e4 7a  z 
    jr v_sub_7931h             ;81e5 18 7e  . ~ 

v_sub_78b3h:
    call incIXAndToDEputIXplus2  ;81e7 cd 4a 23  . J # 
    ...
    cp e                       ;81f4 bb  . 
    call z,incIXAndToDEputIXplus2  ;81f5 cc 4a 23  . J # 
l81f8h:
    bit 7,(ix+004h)            ;81f8 dd cb 04 7e  . . . ~ 
    ret                        ;81fc c9  . 
l81fdh:
    dec a                      ;81fd 3d  = 
    jp z,l8380h                ;81fe ca 8c 1c  . . . 
l8201h:
...
vr_l07934h:
    ...
    add hl,de                  ;826e 19  . 
    ex de,hl                   ;826f eb  . 
    jr c,varcUTop              ;8270 38 07  8 . 
    ld hl,(varcCodeEndPt+1)    ;8272 2a 5a 2a  * Z * 
...
varcAddressCounter:
    ...
    inc hl                     ;828a 23  # 
    ld (varcAddressCounter+1),hl  ;828b 22 94 1b  " . . 
    ret                        ;828e c9  . 
l828fh:
    ld a,008h                  ;828f 3e 08  > . 
    jr v_l79c3h                ;8291 18 64  . d 
l8293h:
    dec a                      ;8293 3d  = 
...
v_sub_7962h:
    ...
    ld a,b                     ;829a 78  x 
    jr v_sub_7931h             ;829b 18 c8  . . 
l829dh:
    dec a                      ;829d 3d  = 
    jr nz,l82bfh               ;829e 20 1f    . 
    ld hl,(varcAddressCounter+1)  ;82a0 2a 94 1b  * . . 
    inc hl                     ;82a3 23  # 
    push bc                    ;82a4 c5  . 
    ex (sp),hl                 ;82a5 e3  . 
    pop bc                     ;82a6 c1  . 
...
l82b5h:
    jr v_sub_7931h             ;82b5 18 ae  . . 
l82b7h:
    cp 080h                    ;82b7 fe 80  . . 
    jr nc,l82b5h               ;82b9 30 fa  0 . 
l82bbh:
    ld a,003h                  ;82bb 3e 03  > . 
    jr v_l79c3h                ;82bd 18 38  . 8 
l82bfh:
    dec a                      ;82bf 3d  = 
...
v_sub_79afh:
    ...
    call writeLabelWithSkippedSize  ;82e9 cd 53 23  . S # 
    ld (vr_l07a1ah+1),de       ;82ec ed 53 5b 1c  . S [ . 
    ld a,(hl)                  ;82f0 7e  ~ 
    and 0c0h                   ;82f1 e6 c0  . . 
    jr z,l8300h                ;82f3 28 0b  ( . 
    ld a,MESSAGE_ALREADY_DEFINED  ;82f5 3e 12  > . 
v_l79c3h:
    ld hl,00000h               ;82f7 21 00 00  ! . . 
    ld (varcSourceBufferActiveLine+1),hl   ;82fa 22 ad 24  " . $ 
    jp signalError             ;82fd c3 da 22  . . " 
l8300h:
    set 6,(hl)                 ;8300 cb f6  . . 
    ld hl,(varcAddressCounter+1)  ;8302 2a 94 1b  * . . 
    ex de,hl                   ;8305 eb  . 
    dec hl                     ;8306 2b  + 
    ld (hl),d                  ;8307 72  r 
    dec hl                     ;8308 2b  + 
...
v_l7a25h:
    ...
    ld (varcAddressCounter+1),bc  ;835c ed 43 94 1b  . C . . 
v_l7a2ch:
...
l83ddh:
    ...
    cp 024h                    ;83e0 fe 24  . $ 
    ld de,(varcAddressCounter+1)  ;83e2 ed 5b 94 1b  . [ . . 
    ...
    inc ix                     ;83f1 dd 23  . # 
    call writeLabel            ;83f3 cd 56 23  . V # 
    ld a,(hl)                  ;83f6 7e  ~ 
    and 0c0h                   ;83f7 e6 c0  . . 
...
invokeMonitor:
    ...
    ld b,"a"                   ;84fb 06 61  . a                    (flow (mon) from: 7e06)  7bc7 ld b,61 
...
v_sub_7bdch:
    ...
    call loadRoutine           ;8519 cd f1 1d  . . .               (flow from: 7be4)  7be5 call 7bb1 
    ...
    ld hl,BOTTOM_LINE_VRAM_ADDRESS+1  ;8523 21 e1 50  ! . P        (flow from: 80e0)  7bef ld hl,50e1 
    ld b,00ah                  ;8526 06 0a  . .                    (flow from: 7bef)  7bf2 ld b,0a 
l8528h:
    ld a,(hl)                  ;8528 7e  ~                         (flow from: 7bf2 7c03)  7bf4 ld a,(hl) 
    cp " "                     ;8529 fe 20  .                      (flow from: 7bf4)  7bf5 cp 20 
...
l8533h:
    ...
    jr nz,v_sub_7bdch          ;853e 20 d0    .                    (flow from: 7c08)  7c0a jr nz,7bdc 
    ret                        ;8540 c9  .                         (flow from: 7c0a)  7c0c ret 


v_sub_7c0dh:
    ld b,MAX_FILE_NAME_LENGTH  ;8541 06 0a  . .                    (flow from: 77d4)  7c0d ld b,0a 
    ld hl,fileNameBuffer       ;8543 21 15 19  ! . .               (flow from: 7c0d)  7c0f ld hl,76d5 
l8546h:
    ld a,(hl)                  ;8546 7e  ~                         (flow from: 7c0f)  7c12 ld a,(hl) 
    cp " "                     ;8547 fe 20  .                      (flow from: 7c12)  7c13 cp 20 
    jr nz,l854eh               ;8549 20 03    .                    (flow from: 7c13)  7c15 jr nz,7c1a 
    djnz l8546h                ;854b 10 f9  . . 
    ret                        ;854d c9  . 
l854eh:
v_sub_7c1ah:
    ld b,MAX_FILE_NAME_LENGTH  ;854e 06 0a  . .                    (flow from: 7c15)  7c1a ld b,0a 
    ld hl,fileNameBuffer       ;8550 21 15 19  ! . .               (flow from: 7c1a)  7c1c ld hl,76d5 
    ld de,BOTTOM_LINE_VRAM_ADDRESS+1  ;8553 11 e1 50  . . P        (flow from: 7c1c)  7c1f ld de,50e1 
l8556h:
...
invokeH:
    ld hl,varcHexMode+1        ;856d 21 49 2b  ! I + 
    jr invertLogicAtHLAndRet   ;8570 18 03  . . 
...
invokeW:
    ...
    ; 0 - insert mode
    ; 1 - overwrite mode
    ld hl,varcInsertMode+1     ;8572 21 5f 20  ! _   
...
invokeBasic:
    ...
    jp ROM_StatementReturn     ;8585 c3 76 1b  . v .               (flow from: 7c4d)  7c51 jp 1b76 
...
writeLineOfCodeAndTestKeyboard:
    push hl                    ;8595 e5  . 
    pop ix                     ;8596 dd e1  . . 
    call writeLineOfCode       ;8598 cd cf 24  . . $ 
    ; read keyboard
...
v_sub_7c6ch:
    call getLineBeforeTheActiveOne    ;85a0 cd 72 24  . r $        (flow from: 7d77)  7c6c call 8232 
...
v_sub_7c75h:
    ...
    call comparePositionWithCodeEnd    ;85ac cd 6f 2c  . o ,       (flow from: 825a)  7c78 call 8a2f 
l85afh:
    pop de                     ;85af d1  .                         (flow from: 7c73 8a3e)  7c7b pop de 
    ; do not move if the position would move behind the code end
    jr nc,prometheusWarmStartWithCurrentBuffers  ;85b0 30 70  0 p  (flow from: 7c7b)  7c7c jr nc,7cee 
...
l85dah:
    ...
    call displayNormalCharacter;85db cd a9 29  . . )               (flow from: 7ca6)  7ca7 call 8769 
...
l085ech:
    ...
    or a                       ;85ee b7  . 
    ld a,MESSAGE_ENT           ;85ef 3e 13  > . 
    jp nz,signalError          ;85f1 c2 da 22  . . " 
    call v_sub_7ca1h           ;85f4 cd e1 1e  . . . 
vr_l07cc3h:
    call 00000h                ;85f7 cd 00 00  . . . 
v_l7cc6h:
    call processKey            ;85fa cd 79 28  . y ( 
...
prometheusWarmStartWithMessage:
    ...
    ; clean all buffers
    ld hl,lineBuffer           ;8611 21 e5 2c  ! . ,               (flow from: 8a1d)  7cdd ld hl,8aa5 
    ld bc,(l9478-1-lineBuffer)*256 ; =09e00h                       (flow from: 7cdd)  7ce0 ld bc,9e00 
...
varcLastStatusBarMessage:
    ld a,MESSAGE_COPYRIGHT     ;8632 3e 0f  > .                    (flow from: 7cfd)  7cfe ld a,0f 
    call printStatusBar        ;8634 cd 34 2c  . 4 ,               (flow from: 7cfe)  7d00 call 89f4 
    ld a,MESSAGE_COPYRIGHT     ;8637 3e 0f  > .                    (flow from: 8a1d)  7d03 ld a,0f 
    ld (varcLastStatusBarMessage+1),a  ;8639 32 3f 1f  2 ? .       (flow from: 7d03)   7d05 ld (7cff),a 
    ...
    call writeCodeLineFromIXtoHL  ;8654 cd 78 23  . x #            (flow from: 7d1f)  7d20 call 8138 
    ld a,001h                  ;8657 3e 01  > .                    (flow from: 81b6)  7d23 ld a,01 
    ld (varcInsertMode+1),a    ;8659 32 5f 20  2 _                 (flow from: 7d23)  7d25 ld (7e1f),a 
...
l8665h:
    ld a,MESSAGE_COPYRIGHT                  ;8665 3e 0f  > .                    (flow from: 7d28)  7d31 ld a,0f 
    call printStatusBar        ;8667 cd 34 2c  . 4 ,               (flow from: 7d31)  7d33 call 89f4 
    jr prometheusWarmStartWithCurrentBuffers  ;866a 18 b6  . .     (flow from: 8a1d)  7d36 jr 7cee 
l866ch:
...
l8677h:
    jr prometheusWarmStartWithCurrentBuffers   ;8677 18 a9  . .    (flow from: 7d7c)  7d43 jr 7cee 
l8679h:
    ; CS + 6 - down
...
l8685h:
    ...
    call clearLineAtHL         ;8691 cd 35 28  . 5 ( 
    ld b,006h                  ;8694 06 06  . . 
    ld hl,(varcSourceBufferActiveLine+1)  ;8696 2a ad 24  * . $ 
l8699h:
    call moveToNextLine        ;8699 cd 88 24  . . $ 
    djnz l8699h                ;869c 10 fb  . . 
    call writeLineOfCodeAndTestKeyboard  ;869e cd a1 1e  . . . 
...
l86beh:
    ...
    call clearLineAtHL         ;86ca cd 35 28  . 5 ( 
    ld b,00dh                  ;86cd 06 0d  . . 
    ld hl,(varcSourceBufferActiveLine+1)  ;86cf 2a ad 24  * . $ 
l86d2h:
    call getPreviousLine       ;86d2 cd 75 24  . u $ 
    djnz l86d2h                ;86d5 10 fb  . . 
    call writeLineOfCodeAndTestKeyboard  ;86d7 cd a1 1e  . . . 
...
l86e0h:
    ...
    call nc,getPreviousLine    ;86f2 d4 75 24  . u $ 
...
l86fah:
    ...
    ld hl,(varcSelectedBlockEnd+1)       ;86fe 2a 2b 23  * + # 
    ld (varcSelectedBlockStart+1),hl     ;8701 22 28 23  " ( # 
...
varcInsertMode:
    ...
    call getLineBeforeTheActiveOne    ;8757 cd 72 24  . r $        (flow from: 7e21)  7e23 call 8232 
...
l8763h:
    ld a,MESSAGE_COPYRIGHT     ;8763 3e 0f  > .                    (flow from: 7e21 8989)  7e2f ld a,0f 
    ld (varcLastStatusBarMessage+1),a        ;8765 32 3f 1f  2 ? . (flow from: 7e2f)  7e31 ld (7cff),a 
v_l7e34h:
...
v_sub_7e3bh:
    ...
    ld a,(hl)                  ;877b 7e  ~ 
    rlca                       ;877c 07  . 
    jr c,incAAndRet            ;877d 38 27  8 ' 
    ld c,(hl)                  ;877f 4e  N 
    ld (hl),b                  ;8780 70  p 
    inc hl                     ;8781 23  # 
    ld (hl),c                  ;8782 71  q 
    jr incAAndRet              ;8783 18 21  . ! 
l8785h:
...
l8793h:
    ...
    jr z,incAAndRet            ;879d 28 07  ( .                    (flow from: 7e67)  7e69 jr z,7e72 
l879fh:
...
l87e6h:
    ...
    jr incAAndRet              ;87fb 18 a9  . .                    (flow from: 7ec5)  7ec7 jr 7e72 
...
l8810h:
    call storeAtIXMoveToNextAndIncB  ;8810 cd a2 2b  . . + 
    or a                       ;8813 b7  . 
    jr nz,l880dh               ;8814 20 f7    . 
    dec ix                     ;8816 dd 2b  . + 
    jp l8923h                  ;8818 c3 2f 22  . / " 

v_sub_7ee7h:
    cp ";"                     ;881b fe 3b  .                      (flow from: 7e07)  7ee7 cp 3b 
    jr z,l87fdh                ;881d 28 de  ( .                    (flow from: 7ee7)  7ee9 jr z,7ec9 
    cp " "                     ;881f fe 20  .                      (flow from: 7ee9)  7eeb cp 20 
    call nz,v_sub_856fh        ;8821 c4 af 27  . . '               (flow from: 7eeb)  7eed call nz,856f 
    call skipSpaces            ;8824 cd f5 27  . . '               (flow from: 7eed 8585)  7ef0 call 85b5 
    ...
    call skipSpaces            ;882f cd f5 27  . . '               (flow from: 8585 8590)  7efb call 85b5 
...
l8840h:
    ld de,commandArgumentBuffer;8840 11 11 2d  . . -               (flow from: 7f06 7f09)  7f0c ld de,8ad1 
    ld c,012h                  ;8843 0e 12  . .                    (flow from: 7f0c)  7f0f ld c,12 
    call readCommandArgument   ;8845 cd b7 27  . . '               (flow from: 7f0f)  7f11 call 8577 
...
l88a6h:
    ...
    ld hl,commandArgumentBuffer;88a9 21 11 2d  ! . -               (flow from: 7f72)  7f75 ld hl,8ad1 
...
varcMnemonicIndex:
    ...
    ld hl,instructionsTable-2  ;88cf 21 e1 30  ! . 0               (flow from: 7f9a)  7f9b ld hl,8ea1
    ld bc,INSTRUCTIONS_TABLE_SIZE   ;88d2 01 af 02  . . .          (flow from: 7f9b)  7f9e ld bc,02af
l88d5h:
...
; move to instructionRecord[2]
    ...
    jp po,badInstructionError  ;88dd e2 d8 22  . . "               (flow from: 7fa7)  7fa9 jp po,8098 
...
l88fdh:
    ...
    inc b                      ;891a 04  . 
l891bh:
    ld de,commandArgumentBuffer;891b 11 11 2d  . . -               (flow from: 7fda)  7fe7 ld de,8ad1 
...
l8944h:
    ...
    ld de,commandArgumentBuffer;8949 11 11 2d  . . -               (flow from: 8013)  8015 ld de,8ad1 
...
l895eh:
    ...
    jr c,syntaxError           ;8961 38 5a  8 Z                    (flow from: 802c)  802d jr c,8089 
...
l897eh:
    ...
    call quotesExpected        ;8981 cd cd 22  . . " 
    call storeAtIXMoveToNextAndIncB  ;8984 cd a2 2b  . . + 
    inc hl                     ;8987 23  # 
    ld a,(hl)                  ;8988 7e  ~ 
    call storeAtIXMoveToNextAndIncB  ;8989 cd a2 2b  . . + 
    inc hl                     ;898c 23  # 
    ld a,(hl)                  ;898d 7e  ~ 
l898eh:
    call storeAtIXMoveToNextAndIncB  ;898e cd a2 2b  . . + 
    inc hl                     ;8991 23  # 
    ld a,(hl)                  ;8992 7e  ~ 
    or a                       ;8993 b7  . 
    jr nz,l898eh               ;8994 20 f8    . 
    dec hl                     ;8996 2b  + 
    call quotesExpected        ;8997 cd cd 22  . . " 
...
badMnemonicError:
    ld a,MESSAGE_BAD_MNEMONIC  ;89b1 3e 01  > . 
    jr signalError             ;89b3 18 19  . . 

badOperandError:
    ld a,MESSAGE_BAD_OPERAND   ;89b5 3e 02  > . 
    jr signalError             ;89b7 18 15  . . 

bigNumberError:
    ld a,MESSAGE_BIG_NUMBER    ;89b9 3e 03  > . 
    jr signalError             ;89bb 18 11  . . 

syntaxError:
    ld a,MESSAGE_SYNTAX_HORROR ;89bd 3e 04  > . 
    jr signalError             ;89bf 18 0d  . . 
...
quotesExpected:
    ...
    ret z                      ;89c7 c8  . 
badStringError:
    ld a,MESSAGE_BAD_STRING    ;89c8 3e 05  > . 
    jr signalError             ;89ca 18 02  . . 
badInstructionError:
    ld a,MESSAGE_BAD_INSTRUCTION      ;89cc 3e 06  > . 
signalError:
    ex af,af'                  ;89ce 08  . 
    call beep                  ;89cf cd 53 29  . S ) 
    ex af,af'                  ;89d2 08  . 
errorAction:
    ; not sure with the label name
    call printStatusBar        ;89d3 cd 34 2c  . 4 , 
v_l80a2h:
    call clearStringBuffers    ;89d6 cd 1b 25  . . % 
    ld hl,(varcSourceBufferActiveLine+1)  ;89d9 2a ad 24  * . $ 
    call comparePositionWithCodeEnd           ;89dc cd 6f 2c  . o , 
    call z,getPreviousLine     ;89df cc 75 24  . u $ 
    ld (varcSourceBufferActiveLine+1),hl      ;89e2 22 ad 24  " . $ 
    jp prometheusWarmStartWithCurrentBuffers  ;89e5 c3 2e 1f  . . . 
signalMessage:
    ld hl,VRAM_ADDRESS         ;89e8 21 00 40  ! . @               (flow from: 7bec 89f4)  80b4 ld hl,4000 
v_sub_80b7h:
    call clearLineAtHL         ;89eb cd 35 28  . 5 (               (flow from: 80b4)  80b7 call 85f5 
    cp 009h                    ;89ee fe 09  . .                    (flow from: 8607)  80ba cp 09 
    jr nz,l8a00h               ;89f0 20 0e    .                    (flow from: 80ba)  80bc jr nz,80cc 
    push af                    ;89f2 f5  . 
vr_l080bfh:
    ld hl,symbolString         ;89f3 21 21 23  ! ! # 
    call v_sub_80d7h           ;89f6 cd 17 23  . . # 
    ld hl,symbolString         ;89f9 21 21 23  ! ! # 
    ld (vr_l080bfh+1),hl       ;89fc 22 00 23  " . # 
    pop af                     ;89ff f1  . 
l8a00h:
    ld hl,errorMessages        ;8a00 21 e1 2d  ! . -               (flow from: 80bc)  80cc ld hl,8ba1 
l8a03h:
    ; end of string?
...
v_sub_80d7h:
    ...
    call displayUninvertedCharacter   ;8a0c cd a7 29  . . )        (flow from: 80d7)  80d8 call 8767 
    bit 7,(hl)                 ;8a0f cb 7e  . ~                    (flow from: 877e)  80db bit 7,(hl) 
    inc hl                     ;8a11 23  #                         (flow from: 80db)  80dd inc hl 
    jr z,v_sub_80d7h           ;8a12 28 f7  ( .                    (flow from: 80dd)  80de jr z,80d7 
...
v_sub_80f5h:
    ...
    call getSelectedBlock      ;8a2c cd 27 23  . ' #               (flow from: 80f6)  80f8 call 80e7 
...
writeLabelWithSkippedSize:
    ; skip size
    call toDEputIXplus2        ;8a47 cd 4c 23  . L #               (flow from: 8167)  8113 call 810c 
writeLabel:
varcSymbolTableInderectPt:
...
writeCodeLineFromIXtoLineBuffer:
    ld hl,lineBuffer           ;8a69 21 e5 2c  ! . ,               (flow from: 773d 8291)  8135 ld hl,8aa5 
writeCodeLineFromIXtoHL:
...
l8aa4h:
    ...
    ld (varcLastStatusBarMessage+1),a        ;8ab6 32 3f 1f  2 ? . 
    ret                        ;8ab9 c9  . 
l8abah:
...
printFromDEtoHLwithDecB:
    ...
    ld a,MESSAGE_SOURCE_ERROR  ;8b03 3e 10  > . 
    ld (varcLastStatusBarMessage+1),a        ;8b05 32 3f 1f  2 ? . 
    pop af                     ;8b08 f1  . 
    ret                        ;8b09 c9  . 
l8b0ah:
...
l8b4ah:
    ...
    call writeLabel            ;8b53 cd 56 23  . V #               (flow from: 821e)  821f call 8116 
...
varcSourceBufferActiveLine:
    ...
    ; find the beginning of the visible code
    ld b,LINES_BEFORE_ACCESS_LINE ;8ba3 06 0d  . .                 (flow from: 826c)  826f ld b,0d 
l8ba5h:
    call getPreviousLine       ;8ba5 cd 75 24  . u $               (flow from: 826f 8274)  8271 call 8235 
...
l8bach:
    ...
    call clearLine             ;8baf cd 30 28  . 0 (               (flow from: 827a)  827b call 85f0 
    pop ix                     ;8bb2 dd e1  . .                    (flow from: 8607)  827e pop ix 
    call writeLineOfCode       ;8bb4 cd cf 24  . . $               (flow from: 827e)  8280 call 828f 
    pop hl                     ;8bb7 e1  .                         (flow from: 82b1)  8283 pop hl 
    call moveToNextLine        ;8bb8 cd 88 24  . . $               (flow from: 8283)  8284 call 8248 
...
writeLineOfCode:
    ...
    call writeCodeLineFromIXtoLineBuffer ;8bc5 cd 75 23  . u #     (flow from: 828f)  8291 call 8135 
...
v_sub_82a3h:
    ...
    ld hl,lineBuffer           ;8bda 21 e5 2c  ! . ,               (flow from: 82a3)  82a6 ld hl,8aa5 
...
atHLrepeatBTimesC:
    ...
    djnz atHLrepeatBTimesC     ;8c17 10 fc  . .                    (flow from: 82e2)  82e3 djnz 82e1 
...
l8c28h:
    ...
    jp z,badInstructionError   ;8c35 ca d8 22  . . " 
l8c38h:
...
v_sub_838bh:
    ld hl,commandArgumentBuffer;8cbf 21 11 2d  ! . -               (flow from: 7f14)  838b ld hl,8ad1 
    ld b,"("                   ;8cc2 06 28  . (                    (flow from: 838b)  838e ld b,28 
...
v_sub_83a0h:
    cp ","                     ;8cd4 fe 2c  . ,                    (flow from: 7fd4 7fec 803a)  83a0 cp 2c 
    jr z,l8cdfh                ;8cd6 28 07  ( .                    (flow from: 83a0)  83a2 jr z,83ab 
    inc de                     ;8cd8 13  .                         (flow from: 83a2)  83a4 inc de 
    cp "-"                     ;8cd9 fe 2d  . -                    (flow from: 83a4)  83a5 cp 2d 
    jr z,l8cdfh                ;8cdb 28 02  ( .                    (flow from: 83a5)  83a7 jr z,83ab 
    inc de                     ;8cdd 13  . 
    inc de                     ;8cde 13  . 
l8cdfh:
    call testClosingBracketOrComma   ;8cdf cd d2 26  . . &               (flow from: 83a2 83a7)  83ab call 8492 
l8ce2h:
    jp c,syntaxError           ;8ce2 da c9 22  . . "               (flow from: 8417 849d)  83ae jp c,8089 
    cp "+"                     ;8ce5 fe 2b  . +                    (flow from: 83ae)  83b1 cp 2b 
    jr z,l8cf0h                ;8ce7 28 07  ( .                    (flow from: 83b1)  83b3 jr z,83bc 
    cp "-"                     ;8ce9 fe 2d  . -                    (flow from: 83b3)  83b5 cp 2d 
    jr nz,l8cf5h               ;8ceb 20 08    .                    (flow from: 83b5)  83b7 jr nz,83c1 
    call storeAtIXMoveToNextAndIncB  ;8ced cd a2 2b  . . + 
l8cf0h:
    call testClosingBracketOrComma   ;8cf0 cd d2 26  . . & 
    jr c,l8ce2h                ;8cf3 38 ed  8 . 
l8cf5h:
    cp "$"                     ;8cf5 fe 24  . $                    (flow from: 83b7)  83c1 cp 24 
    jr nz,l8cfeh               ;8cf7 20 05    .                    (flow from: 83c1)  83c3 jr nz,83ca 
    call storeAndTestNextClosingBracketOrComma  ;8cf9 cd cf 26     (flow from: 83c3)  83c5 call 848f 
...
l8cfeh:
    ...
    call isLetter              ;8d01 cd 6e 29  . n )               (flow from: 83cb)  83cd call 872e 
    ...
    call testClosingBracketOrComma  ;8d28 cd d2 26  . . &               (flow from: 83f3)  83f4 call 8492 
...
l8d31h:
    ...
    cp "+"                     ;8d33 fe 2b  . +                    (flow from: 83fe)  83ff cp 2b 
...
l8d48h:
    call storeAndTestNextClosingBracketOrComma  ;8d48 cd cf 26     (flow from: 8401)  8414 call 848f 
    jr l8ce2h                  ;8d4b 18 95  . .                    (flow from: 849d)  8417 jr 83ae 


v_sub_8419h:
    cp "\""                    ;8d4d fe 22  . "                    (flow from: 83fa)  8419 cp 22 
    jr z,l8d93h                ;8d4f 28 42  ( B                    (flow from: 8419)  841b jr z,845f     
    ld c,00ah                  ;8d51 0e 0a  . .                    (flow from: 841b)  841d ld c,0a 
    call isNumber              ;8d53 cd 66 29  . f )               (flow from: 841d)  841f call 8726 
...
l8d66h:
    call storeAndTestNextClosingBracketOrComma  ;8d66 cd cf 26  . . & 
...
l8d7ah:
    ...
    call storeAndTestNextClosingBracketOrComma ;8d8d cd cf 26      (flow from: 8458)  8459 call 848f 
...
v_sub_847ah:
    call storeAndTestNextClosingBracketOrComma  ;8dae cd cf 26  . . & 
    or a                       ;8db1 b7  . 
...
storeAndTestNextClosingBracketOrComma:
    call storeAtIXMoveToNextAndIncB   ;8dc3 cd a2 2b  . . +        (flow from: 83c5 8414 8459)  848f call 8962 
testClosingBracketOrComma:
    ld a,(de)                  ;8dc6 1a  .                         (flow from: 83ab 83f4 8968)  8492 ld a,(de) 
    inc de                     ;8dc7 13  .                         (flow from: 8492)  8493 inc de 
    cp ")"                     ;8dc8 fe 29  . )                    (flow from: 8493)  8494 cp 29 
    jr z,setFlagForSyntaxError ;8dca 28 06  ( .                    (flow from: 8494)  8496 jr z,849e 
    cp ","                     ;8dcc fe 2c  . ,                    (flow from: 8496)  8498 cp 2c 
    jr z,setFlagForSyntaxError                ;8dce 28 02  ( .                    (flow from: 8498)  849a jr z,849e 
...
l8e2ch:
    ...
    cp "("                     ;8e2d fe 28  . (                    (flow from: 84f8)  84f9 cp 28 
    ...
    cp "i"                     ;8e34 fe 69  . i                    (flow from: 84ff)  8500 cp 69 
...
l8e6eh:
    ...
    djnz compareWithMnemonics  ;8e75 10 e4  . .                    (flow from: 8540)  8541 djnz 8527 
...
v_sub_856fh:
    ld b," "                   ;8ea3 06 20  .                      (flow from: 7eed 7ef8)  856f ld b,20 
    jr l8eadh                  ;8ea5 18 06  . .                    (flow from: 856f)  8571 jr 8579 
v_sub_8573h:
    ld b,","                   ;8ea7 06 2c  . ,                    (flow from: 7f03)  8573 ld b,2c 
...
l8eadh:
    ...
    cp "\""                    ;8eb0 fe 22  . "                    (flow from: 85b1)  857c cp 22 
    jr z,l8ed9h                ;8eb2 28 25  ( %                    (flow from: 857c)  857e jr z,85a5 
    cp "'"                     ;8eb4 fe 27  . '                    (flow from: 857e)  8580 cp 27 
...
l8eb8h:
    ...
    ; skip spaces
    cp " "                     ;8eba fe 20  .                      (flow from: 8585)  8586 cp 20 
...
skipSpaces:
    ...
    cp " "                     ;8eec fe 20  .                      (flow from: 85b1 85b4)  85b8 cp 20 
    ret nz                     ;8eee c0  .                         (flow from: 85b8)  85ba ret nz 
    inc hl                     ;8eef 23  #                         (flow from: 85ba)  85bb inc hl 
    jr skipSpaces              ;8ef0 18 f7  . .                    (flow from: 85bb)  85bc jr 85b5 


repaintEditLine:
    ld hl,l96a4-1              ;8ef2 21 af 2f  ! . /               (flow from: 7cf4)  85be ld hl,8d6f 
...
v_l85c7h:
    call clearLineAtHL         ;8efb cd 35 28  . 5 (               (flow from: 85c4)  85c7 call 85f5 
...
clearLineAtHL:
    ld (varcPrintingPosition+1),hl       ;8f29 22 c8 29  " . )     (flow from: 22ca 80b7 85c7)  85f5 ld (8788),hl 
v_sub_85f8h:
...
readKeyCode:
    ...
    call isLetter              ;8f41 cd 6e 29  . n )               (flow (mon) from: 860c)  860d call 872e 
...
l8fafh:
    ...
    jr z,processKey            ;8fb5 28 b6  ( .                    (flow from: 867f)  8681 jr z,8639 
...
isNumber:
    cp "0"                     ;905a fe 30  . 0                    (flow from: 841f 865c 8724 87b2)  8726 cp 30 
    ret c                      ;905c d8  .                         (flow from: 8726)  8728 ret c 
    cp "9"                     ;905d fe 39  . 9                    (flow from: 8728)  8729 cp 39 
...
; ignore if the command key is not in a-z or A-Z
    cp "A"                     ;9062 fe 41  . A                    (flow from: 82bd 83cd 8673 86d7 87bd)  872e cp 41 
    ret c                      ;9064 d8  .                         (flow from: 872e)  8730 ret c 
    cp "z"                     ;9065 fe 7a  . z                    (flow from: 8730)  8731 cp 7a 
    ret nc                     ;9067 d0  .                         (flow from: 8731)  8733 ret nc 
    cp "Z"+1                   ;9068 fe 5b  . [                    (flow from: 8733)  8734 cp 5b 
    jr c,l906fh                ;906a 38 03  8 .                    (flow from: 8734)  8736 jr c,873b 
    cp "a"                     ;906c fe 61  . a                    (flow from: 8736)  8738 cp 61 
...
displaySpaceSafely:
    ld a," "                   ;9071 3e 20  >                      (flow from: 8a12)  873d ld a,20 
...
v_sub_874ah:
    ...
    jr c,displayUninvertedCharacter           ;9080 38 19  8 .     (flow from: 874a)  874c jr c,8767 
...
l908dh:
    ...
    call displayUninvertedCharacter    ;9090 cd a7 29  . . )       (flow from: 875b)  875c call 8767 
...
displaySpace:
    ld a," "                   ;9099 3e 20  >                      (flow from: 8764)  8765 ld a,20 
...
varcPrintingPosition:
    ld de,SECOND_LINE_ADDRESS  ;90bb 11 20 40  .   @               (flow from: 8786)  8787 ld de,401f 
...
l90d9h:
    ld (varcPrintingPosition+1),hl       ;90d9 22 c8 29  " . )     (flow from: 8799 87a4)  87a5 ld (8788),hl 
...
l90e3h:
    ...
    call isNumber             ;90e6 cd 66 29  . f )               (flow from: 85b1)  87b2 call 8726 
    jr z,l90f6h                ;90e9 28 0b  ( .                    (flow from: 8728 872b 872d)  87b5 jr z,87c2 
    ; uppercase
    res 5,a                    ;90eb cb af  . .                    (flow from: 87b5)  87b7 res 5,a 
    cp "_"                     ;90ed fe 5f  . _                    (flow from: 87b7)  87b9 cp 5f 
    jr z,l90f6h                ;90ef 28 05  ( .                    (flow from: 87b9)  87bb jr z,87c2 
    call isLetter              ;90f1 cd 6e 29  . n )               (flow from: 87bb)  87bd call 872e 
...
l90f6h:
    ...
    cp LABEL_LENGTH            ;90fb fe 09  . .                    (flow from: 87c6)  87c7 cp 09 
...
varcSymbolTablePt:
    ld hl,symbolTableDefaultPt ;910a 21 76 3e  ! v >               (flow from: 87d4)  87d6 ld hl,b3b2 
...
varcCodeEndPt:
    ld hl,codeEndDefaultPt     ;914d 21 78 3e  ! x >            (flow from: 8818)  8819 ld hl,ac31 
...
l91a4h:
    ...
    ld hl,(varcCodeEndPt+1)    ;91a6 2a 5a 2a  * Z *               (flow from: 8871)  8872 ld hl,(881a) 
    ...
    ld ix,(varcSymbolTablePt+1)       ;91e9 dd 2a 17 2a            (flow from: 88b4)  88b5 ld ix,(87d7) 
...
l9201h:
    ...
    ld hl,(varcSymbolTablePt+1)       ;920d 2a 17 2a  * . *        (flow from: 88d6)  88d9 ld hl,(87d7) 
...
varcHexMode:
    ...
    jr z,printDecNumberToIX    ;923f 28 19  ( .                    (flow from: 890a)  890b jr z,8926 
printHexNumberToIX:
    ld (ix+000h),"#"           ;9241 dd 36 00 23  . 6 . # 
    inc ix                     ;9245 dd 23  . # 
    ld de,01000h               ;9247 11 00 10  . . . 
    call storeNumberOrderToIX  ;924a cd 81 2b  . . + 
    ld d,001h                  ;924d 16 01  . . 
    call storeNumberOrderToIX  ;924f cd 81 2b  . . + 
v_sub_891eh:
    ld de,00010h               ;9252 11 10 00  . . . 
    call storeNumberOrderToIX  ;9255 cd 81 2b  . . + 
    jr l9271h                  ;9258 18 17  . . 
printDecNumberToIX:
    ld de,10000                ;925a 11 10 27  . . '               (flow from: 890b)  8926 ld de,2710 
    call storeNumberOrderToIX  ;925d cd 81 2b  . . +               (flow from: 8926)  8929 call 8941 
    ld de,1000                 ;9260 11 e8 03  . . .               (flow from: 8961)  892c ld de,03e8 
    call storeNumberOrderToIX  ;9263 cd 81 2b  . . +               (flow from: 892c)  892f call 8941 
v_sub_8932h:
    ld de,100                  ;9266 11 64 00  . d .               (flow from: 8961)  8932 ld de,0064 
    call storeNumberOrderToIX  ;9269 cd 81 2b  . . +               (flow from: 8932)  8935 call 8941 
    ld e,10                    ;926c 1e 0a  . .                    (flow from: 8961)  8938 ld e,0a 
    call storeNumberOrderToIX  ;926e cd 81 2b  . . +               (flow from: 8938)  893a call 8941 
l9271h:
...
storeNumberOrderToIX:
    ; HL - number
    ; DE - divisor
    ld a,-1                    ;9275 3e ff  > .                    (flow from: 8929 892f 8935 893a 893f)  8941 ld a,ff 
l9277h:
...
l9284h:
    ...
    add a,"0"                  ;9286 c6 30  . 0                    (flow from: 8950)  8952 add a,30 
    cp "9"+1                   ;9288 fe 3a  . :                    (flow from: 8952)  8954 cp 3a 
    jr c,l928eh                ;928a 38 02  8 .                    (flow from: 8954)  8956 jr c,895a 
    ; skip 7 characters in the ASCII table
    add a,"A"-("9"+1)            ;928c c6 07  . . 
l928eh:
    call storeAtIXAndMoveToNext;928e cd a3 2b  . . +               (flow from: 8956)  895a call 8963 
...
l92c3h:
    ...
    ld hl,(varcCodeEndPt+1)    ;92d7 2a 5a 2a  * Z *               (flow from: 89a2)  89a3 ld hl,(881a) 
...
l92e7h:
    ...
    ld hl,varcSelectedBlockStart+1       ;92f0 21 28 23  ! ( #               (flow from: 89bb)  89bc ld hl,80e8 
    call v_sub_89dah           ;92f3 cd 1a 2c  . . ,               (flow from: 89bc)  89bf call 89da 
    ld hl,varcSelectedBlockEnd+1         ;92f6 21 2b 23  ! + #               (flow from: 89e5)  89c2 ld hl,80eb 
    call v_sub_89dah           ;92f9 cd 1a 2c  . . ,               (flow from: 89c2)  89c5 call 89da 
    ld hl,varcCodeEndPt+1      ;92fc 21 5a 2a  ! Z *               (flow from: 89e5)  89c8 ld hl,881a 
    call v_sub_89d1h           ;92ff cd 11 2c  . . ,               (flow from: 89c8)  89cb call 89d1 
    ld hl,varcSymbolTablePt+1         ;9302 21 17 2a  ! . *        (flow from: 8989)  89ce ld hl,87d7 
v_sub_89d1h:
...
v_sub_89e8h:
    ...
    call readFileNameWithColon ;9320 cd f6 18  . . .               (flow from: 89e9)  89ec call 76b6 
...
comparePositionWithCodeEnd:
    ...
    ld de,(varcSymbolTablePt+1)       ;9369 ed 5b 17 2a  . [ .     (flow from: 8a34)  8a35 ld de,(87d7) 
    ; reset carry
...
invokeCopy:
    call getSelectedBlock      ;9373 cd 27 23  . ' # 
    push hl                    ;9376 e5  . 
    push de                    ;9377 d5  . 
...
l9386h:
    ...
    ret c                      ;9388 d8  . 
    push bc                    ;9389 c5  . 
    call moveToNextLine        ;938a cd 88 24  . . $ 
...
l93a2h:
    ...
    ld hl,(varcCodeEndPt+1)    ;93aa 2a 5a 2a  * Z *               (flow from: 8a75)  8a76 ld hl,(881a) 
    ...
    ld hl,varcSelectedBlockStart+1       ;93c7 21 28 23  ! ( #     (flow from: 8989)  8a93 ld hl,80e8 
    call v_sub_8969h           ;93ca cd a9 2b  . . +               (flow from: 8a93)  8a96 call 8969 
    ld hl,varcSelectedBlockEnd+1         ;93cd 21 2b 23  ! + #     (flow from: 8975)  8a99 ld hl,80eb 
