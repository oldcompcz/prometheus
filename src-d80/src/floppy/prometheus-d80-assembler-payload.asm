...
;
; This file assembles the complete logical payload at $67EE.  For the
...
DISK_PAYLOAD_ORIGIN: equ 067eeh
...
assemblerOnlyMonitorFallbackAddress:
    defw ENTRY_POINT_WITHOUT_MONITOR   ; MONITOR command safely returns to the assembler entry
